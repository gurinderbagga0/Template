var OrgChart = function (t, e) {
    ...
    null != this.config.nodeMouseClickBehaviour && (this.config.nodeMouseClick = this.config.nodeMouseClickBehaviour), null != this.config.mouseScroolBehaviour && (this.config.mouseScrool = this.config.mouseScroolBehaviour), OrgChart._validateConfig(this.config) && (this.server = null, this._vScroll = {}, this.config.ui || (this.ui = OrgChart.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new OrgChart.editUI, this.editUI.init(this), null === this.server && (this.server = new OrgChart.server(this.config)), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new OrgChart.searchUI, this.searchUI.init(this), this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new OrgChart.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new OrgChart.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new OrgChart.notifierUI, this.notifierUI.init(this), this.config.dragDropMenuUI ? this.dragDropMenuUI = this.config.dragDropMenuUI : this.dragDropMenuUI = new OrgChart.menuUI, this.dragDropMenuUI.init(this, this.config.dragDropMenu), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new OrgChart.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element, this.config, function () {
        ...
        r._draw(!0, OrgChart.action.xScroll)
    })), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = !1, this.response = null, this._setInitialSizeIfNotSet(), this._draw(!1, OrgChart.action.init))
};
OrgChart.prototype.draw = function (t, e, r) {
    ...
    return e
}, OrgChart.prototype._draw = function (t, m, O, x) {
    var y = this;
    this._hideBeforeAnimationCompleted = !1;
    var e = m == OrgChart.action.init ? null : this.getViewBox();
    this.server.read(t, this.width(), this.height(), e, m, O, function (t) {
        y.editUI.fields = t.allFields;
        var e = y.ui.defs(),
            r = y.getScale(t.viewBox);
        e += y.ui.pointer(y.config, m, r);
        var i = y.getViewBox(),
            a = t.viewBox;
        for (var o in y._initialized || (y.element.innerHTML = '<div id="bg-tests"></div>'), t.visibleNodes) {
            var n = t.visibleNodes[o];
            e += y.ui.node(n, y._get(o), t.animations, y.config, void 0, void 0, void 0, m, r, y), e += y.ui.secondLinks(t.visibleNodes, n, y.config, t.boundary, r), e += y.ui.link(n, y, y.config, r), e += y.ui.expandCollapse(n, y.config, m, r)
        }
        if (e += y.ui.lonely(y.config), m !== OrgChart.action.centerNode && m !== OrgChart.action.insert && m !== OrgChart.action.expandCollapse && m !== OrgChart.action.update || (a = i), m === OrgChart.action.init && null != i && (a = i), m !== OrgChart.action.exporting) {
            y.response = t;
            C = y.ui.svg(y.width(), y.height(), a, y.config, e);
            if (y._initialized) {
                var l = y.getSvg(),
                    s = l.parentNode;
                s.removeChild(l), s.insertAdjacentHTML("afterbegin", C), y._attachEventHandlers(), y.xScrollUI.addListener(y.getSvg()), y.yScrollUI.addListener(y.getSvg()), y.xScrollUI.setPosition(), y.yScrollUI.setPosition()
            } else {
                y.element.innerHTML = y.ui.css() + y.ui.exportMenuButton(y.config) + C, y._attachInitEventHandlers(), y._attachEventHandlers(), y.config.showXScroll === OrgChart.scroll.visible && (y.xScrollUI.create(y.width(), y.config.padding), y.xScrollUI.setPosition(), y.xScrollUI.addListener(y.getSvg())), y.config.showYScroll === OrgChart.scroll.visible && (y.yScrollUI.create(y.height(), y.config.padding), y.yScrollUI.setPosition(), y.yScrollUI.addListener(y.getSvg())), y.config.enableSearch && y.searchUI.addSearchControl(), y.toolbarUI.init(y, y.config.toolbar);
                var h = document.createElement("div");
                h.setAttribute("id", "bg-tests"), y.element.appendChild(h)
            }
            var d = !1;
            y.notifierUI.show(t.notif);
            var c = y.response.animations;
            if (0 < c[0].length) {
                y._hideBeforeAnimation(c[0].length);
                for (var g = 0; g < c[0].length; g++) c[0][g] = y.getNodeElement(c[0][g]);
                OrgChart.anim(c[0], c[1], c[2], y.config.anim.duration, y.config.anim.func, function () {
                    d || (x && x(), y.config.onRedraw && y.config.onRedraw(y), y._showAfterAnimation(), d = !0)
                })
            }
            m === OrgChart.action.centerNode ? OrgChart.anim(y.getSvg(), {
                viewbox: i
            }, {
                    viewbox: y.response.viewBox
                }, y.config.anim.duration, y.config.anim.func, function () {
                    y.ripple(O.rippleId ? O.rippleId : O.id)
                }, function () {
                    y.xScrollUI.setPosition(), y.yScrollUI.setPosition(), d || (x && x(), y.config.onRedraw && y.config.onRedraw(y), y._showAfterAnimation(), d = !0)
                }) : !i || !y.response || i[0] == y.response.viewBox[0] && i[1] == y.response.viewBox[1] && i[2] == y.response.viewBox[2] && i[3] == y.response.viewBox[3] || m !== OrgChart.action.insert && m !== OrgChart.action.expandCollapse && m !== OrgChart.action.update && m !== OrgChart.action.init ? 0 == c[0].length && (d || (x && x(), y.config.onRedraw && y.config.onRedraw(y), d = !0)) : OrgChart.anim(y.getSvg(), {
                    viewbox: i
                }, {
                        viewbox: y.response.viewBox
                    }, 500, OrgChart.anim.inOutPow, function () {
                        y.xScrollUI.setPosition(), y.yScrollUI.setPosition(), d || (x && x(), y.config.onRedraw && y.config.onRedraw(y), d = !0)
                    }), y._initialized = !0
        } else {
            var p = t.boundary,
                f = p.maxX - p.minX + 2 * y.config.padding,
                u = p.maxY - p.minY + 2 * y.config.padding,
                C = y.ui.svg(f, u, [p.minX - y.config.padding, p.minY - y.config.padding, f, u], y.config, e, r);
            x(C)
        }
    })
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            u.setAttribute("id", O);
            var x = OrgChart.t(i.templateName, this.getScale());
            C.setAttribute("x", x.ripple.rect ? x.ripple.rect.x : 0), C.setAttribute("y", x.ripple.rect ? x.ripple.rect.y : 0), C.setAttribute("width", x.ripple.rect ? x.ripple.rect.width : i.w), C.setAttribute("height", x.ripple.rect ? x.ripple.rect.height : i.h), C.setAttribute("rx", x.ripple.radius), C.setAttribute("ry", x.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", n), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", x.ripple.color), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, {
                r: 0,
                opacity: 1
            }, {
                    r: p,
...
}, OrgChart.prototype.center = function (t, e, r, i) {
    ...
    var e = this.response.visibleNodes[t];
    if (null == e)
        for (var r in this.response.visibleNodes)
            for (var i = this.response.visibleNodes[r].bgnodes, a = 0; a < i.length; a++)
    ...
    var r = this.get(t.id);
    if (!0 === e && this.config.onUpdate && !1 === this.config.onUpdate(this, r, t)) return !1;
    ...
    this.remove(t, e), this._draw(!1, OrgChart.action.update, null, function () {
        OrgChart._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary)
    })
}, OrgChart.prototype.remove = function (t, e) {
    var r = this.getBGNode(t);
    if ((r.isChildOfGroup && this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), !0 === e && this.config.onRemove) && !1 === this.config.onRemove(this, t)) return !1;
    ...
    if ((null == t.id && console.error("Call addNode without id"), !0 === e && this.config.onAdd) && !1 === this.config.onAdd(this, t)) return !1;
    this.config.nodes.push(t)
}, OrgChart.prototype.addTag = function (t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if ((i[t] = e, !0 === r && this.config.onUpdateTags) && !1 === this.config.onUpdateTags(this, i)) return !1;
    this.config.tags = i
}, OrgChart.prototype.removeTag = function (t, e) {
    var r = JSON.parse(JSON.stringify(this.config.tags));
    if ((delete r[t], !0 === e && this.config.onUpdateTags) && !1 === this.config.onUpdateTags(this, r)) return !1;
    this.config.tags = r
}, OrgChart.prototype._updateTag = function (t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if ((i[t][e] = r, this.config.onUpdateTags) && !1 === this.config.onUpdateTags(this, i)) return !1;
    this.config.tags = i;
    var a = this;
    this._draw(!1, OrgChart.action.update, {
        id: t
    ...
    if (r.isGroup || i.isGroup || r.isChildOfGroup || i.isChildOfGroup)
        if (r.isGroup || i.isGroup || !r.isChildOfGroup || i.isChildOfGroup)
            if (r.isGroup || i.isGroup || r.isChildOfGroup || !i.isChildOfGroup) !r.isGroup && !i.isGroup && r.isChildOfGroup && i.isChildOfGroup && (this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i._groupParentNodeId, !0));
                ...
                n = i._groupParentNodeId;
                this.addNodeTag(r.id, n, !0);
                l = this.getBGNode(n).bgnodes[0].pid;
                this.link(r.id, l)
            }
        else {
            var n = OrgChart._randomId();
            this.addTag(n, {
                group: !0,
                groupName: "",
                groupState: OrgChart.EXPAND,
                template: "group_grey"
            }, !0), this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, n, !0), this.addNodeTag(i.id, n, !0);
        ...
        this.addTag(n, {
            ...
            groupState: OrgChart.EXPAND,
            template: "group_grey"
        }, !0), this.addNodeTag(r.id, n, !0), this.addNodeTag(i.id, n, !0);
        var l = this._get(i.id).pid;
        this.link(r.id, l)
    }
    this._draw(!1, OrgChart.action.update, {
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.anim = function (d, c, g, p, f, u, C) {
    var m, O = 1,
        x = p / 10 + 1;
    document.getElementsByTagName("g");
    Array.isArray(d) || (d = [d]), Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), m = setInterval(function () {
        for (var t = 0; t < d.length; t++)
            for (var e in g[t]) {
                var r = OrgChart._arrayContains(["top", "left", "right", "bottom", "width"], e.toLowerCase()) ? "px" : "";
                switch (e.toLowerCase()) {
                    case "d":
                        var a = f((10 * O - 10) / p) * (g[t][e][0] - c[t][e][0]) + c[t][e][0],
                            o = f((10 * O - 10) / p) * (g[t][e][1] - c[t][e][1]) + c[t][e][1];
                        d[t].setAttribute("d", d[t].getAttribute("d") + " L" + a + " " + o);
                        break;
                    case "r":
                        var n = f((10 * O - 10) / p) * (g[t][e] - c[t][e]) + c[t][e];
                        d[t].setAttribute("r", n);
                        break;
                    case "transform":
                        if (g[t][e]) {
                            var l = c[t][e],
                                s = g[t][e],
                                h = [0, 0, 0, 0, 0, 0];
                            for (i in l) h[i] = f((10 * O - 10) / p) * (s[i] - l[i]) + l[i];
                            d[t].setAttribute("transform", "matrix(" + h.toString() + ")")
                        }
                        break;
                    case "viewbox":
                        if (g[t][e]) {
                            for (i in l = c[t][e], s = g[t][e], h = [0, 0, 0, 0], l) h[i] = f((10 * O - 10) / p) * (s[i] - l[i]) + l[i];
                    ...
                    case "margin":
                        if (g[t][e]) {
                            for (i in l = c[t][e], s = g[t][e], h = [0, 0, 0, 0], l) h[i] = f((10 * O - 10) / p) * (s[i] - l[i]) + l[i];
                            for (i = 0; i < h.length; i++) parseInt(h[i]);
                            d[t] && d[t].style && (d[t].style[e] = n)
                        }
                        break;
                    default:
                        n = f((10 * O - 10) / p) * (g[t][e] - c[t][e]) + c[t][e], d[t] && d[t].style && (d[t].style[e] = n + r)
                }
            }
        C && C(), 1 + x < (O += 1) && (clearInterval(m), u && u(d))
    }, 10)
    ...
    t = this.getSvg();
    /Mobi/i.test(navigator.userAgent) || /Android/i.test(navigator.userAgent) ? (this._addEvent(t, "touchstart", this._globalMouseDownHandler), this._addEvent(t, "touchend", this._globalClickHandler)) : (this._addEvent(t, "mousedown", this._globalMouseDownHandler), this._addEvent(t, "click", this._globalClickHandler), this._addEvent(t, "dblclick", this._globalDbClickHandler), this.config.mouseScrool == OrgChart.action.zoom && (this._addEvent(t, "DOMMouseScroll", this._mouseScrollHandler), this._addEvent(t, "mousewheel", this._mouseScrollHandler)));
    ...
    }, void 0 === OrgChart && (OrgChart = {}), OrgChart.VERSION = "4.5.3", OrgChart.orientation = {}, OrgChart.orientation.top = 0, OrgChart.orientation.bottom = 1, OrgChart.orientation.right = 2,
    OrgChart.orientation.left = 3, OrgChart.orientation.top_left = 4, OrgChart.orientation.bottom_left = 5, OrgChart.orientation.right_top = 6, OrgChart.orientation.left_top = 7, OrgChart.CENTER = 8,
    OrgChart.ORIENTATION = 9, OrgChart.TEXT_THRESHOLD = 150, OrgChart.IMAGES_THRESHOLD = 70, OrgChart.LINKS_THRESHOLD = 150, OrgChart.EXPCOLL_THRESHOLD = 40, OrgChart.ANIM_THRESHOLD = 50,
    OrgChart.ID = "id", OrgChart.PID = "pid", OrgChart.TAGS = "tags", OrgChart.NODES = "nodes", OrgChart.ELASTIC = "elastic", OrgChart.MAX_DEPTH = 100, OrgChart.SCALE_FACTOR = 1.44,
    OrgChart.EXPAND = 0, OrgChart.COLLAPSE = 1, OrgChart.LAZY_LOADING_FACTOR = 500, OrgChart.action = {}, OrgChart.action.expandCollapse = 0, OrgChart.action.groupMaxMin = 100,
    OrgChart.action.edit = 1, OrgChart.action.zoom = 2, OrgChart.action.xScroll = 3, OrgChart.action.yScroll = 4, OrgChart.action.none = 5, OrgChart.action.init = 6, OrgChart.action.update = 7,
    OrgChart.action.pan = 8, OrgChart.action.centerNode = 9, OrgChart.action.resize = 10, OrgChart.action.insert = 11, OrgChart.action.insertfirst = 12, OrgChart.action.details = 13,
    OrgChart.action.exporting = 14, OrgChart.none = 400001, OrgChart.scroll = {}, OrgChart.scroll.visible = 1, OrgChart.match = {}, OrgChart.match.height = 100001, OrgChart.match.width = 100002,
    OrgChart.match.boundary = 100003, OrgChart.COLLAPSE_PARENT_NEIGHBORS = 1, OrgChart.COLLAPSE_SUB_CHILDRENS = 2, OrgChart.normal = 0, OrgChart.mixed = 1, OrgChart.tree = 2, OrgChart.treeLeftOffset = 3,
    OrgChart.treeRightOffset = 4, OrgChart.nodeOpenTag = '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" level="{level}">',
    OrgChart.linkOpenTag = '<g link-id="[{id}][{child-id}]" class="{class}" level="{level}">', OrgChart.secondLinkOpenTag = '<g second-link-id="[{id}][{child-id}]">',
    OrgChart.expcollOpenTag = '<g control-expcoll-id="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">', OrgChart.groupNodesOpenTag = '<g transform="matrix(1,0,0,1,{x},{y})">',
    OrgChart.linkFieldsOpenTag = '<g transform="matrix(1,0,0,1,{x},{y}) rotate({rotate})">', OrgChart.grCloseTag = "</g>",
    ...
    OrgChart.RES = {}, OrgChart.RES.IT_IS_LONELY_HERE_LINK = "It's lonely here, add your first node", OrgChart.MAXIMIZE = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline  stroke="#aeaeae" stroke-width="2" points="9,6 17,13 9,20" fill="none"></polyline></g>',
    OrgChart.MINIMIZE = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline stroke="#aeaeae" stroke-width="2" points="17,6 9,13 17,20" fill="none"></polyline></g>',
    OrgChart.MAX_NODES_MESS = "The evaluation version is limited to 200 nodes! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>",
    ...
    OrgChart.A4w = 595, OrgChart.A4h = 842, "undefined" != typeof module && (module.exports = OrgChart.VERSION), OrgChart.input = function (t, e, r, i, a, o) {
    null == i && (i = !1);
    ...
    if (d.innerHTML = "Upload", d.style.position = "absolute", d.style.right = 0, n.style.margin = "14px 14px 7px 14px", n.style.textAlign = "left", n.style.position = "relative", h.style.border = "1px solid #d7d7d7", h.style.backgroundColor = "#d7d7d7", h.style.display = "block", h.style.width = "100%", l.style.floa = "left", l.style.color = "#bcbcbc", s.style.border = "none", s.style.outline = "none", s.style.width = "100%", a && (s.style.width = "80%"), s.style.fontSize = "16px", s.readOnly = i, null != e && null != e && (s.value = e), null != r && null != r && (s.placeholder = r), null != t && null != t && (l.innerHTML = t), l.setAttribute("label", t), s.style.color = "#7a7a7a", i || s.addEventListener("focus", function () {
        ...
        t.setAttribute("type", "file"), t.style.display = "none", t.onchange = function () {
            if (o) {
                var t = this.files[0];
                o(t, e.parentNode.querySelector("input"))
            }
    ...
    this.obj = t, this.fields = null, this.node = null
}, OrgChart.editUI.prototype.show = function (t, e) {
    this.hide(), this.node = this.obj.getBGNode(t), this.wrapperElement = document.getElementById("bgEditForm"), this.wrapperElement && this.obj.element.removeChild(this.wrapperElement), this.wrapperElement = document.createElement("div");
    ...
    //var l = this.fields,
    var l = ["Position Number", "Name", "Phone", "Email", "Title", "Program office", "Address", "City", "County", "State","Zip Code"],
            ...
            if (d)
                for (var g = 0; g < d.length; g++) {
                    ...
                    Object.assign(p.style, {
                        ...
                        "user-select": "none"
                    }), p.innerHTML = d[g], n.appendChild(p)
                }
        } else o.appendChild(OrgChart.input(l[h], d, null, !0))
    }
    ...
    l.innerHTML = '<div label="isAssistant" style="margin-top: 10px;display:inline-block;">Assistant</div><label class="bg-switch"><input type="checkbox" ' + s + '><span class="bg-slider round"></span></label>', this.wrapperElement.appendChild(e), e.appendChild(r), e.appendChild(n), r.appendChild(a), OrgChart.htmlRipple(r);
    var h = this.fields,
    ...
    for (var c = 0; c < h.length; c++) {
        ...
        if (t.isGroup && (g = this.obj.config.tags[t.id]["group" + h[c]]), "tags" != h[c])
            if (OrgChart._fieldIsImg(this.obj.config, h[c])) {
                ...
                n.appendChild(OrgChart.input(h[c], g, null, !1, !0, this.obj.config.onImageUploaded))
            } else n.appendChild(OrgChart.input(h[c], g, null, !1))
    }
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || n.appendChild(l), t.isGroup || n.appendChild(o), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function () {
        i.hide(!0)
    ...
    if (this.wrapperElement) {
        ...
        if (this.node.isGroup && (e = {
            ...
            for (var r = this.wrapperElement.querySelectorAll("[label]"), i = 0; i < r.length; i++) {
                ...
                if (null != a) {
                    var o = r[i].parentNode.getElementsByTagName("input")[0].value;
                    if (a === OrgChart.TAGS) e.tags = o.split(",");
                    else if ("isAssistant" === a) {
                        var n = r[i].parentNode.getElementsByTagName("input")[0].checked;
...
}, OrgChart.menuUI.prototype.show = function (t, e, i, a, o) {
    var n = this;
    this.hide();
    var r = "";
    for (var l in o || (o = this.menu), o) {
        var s = o[l].icon,
            h = o[l].text;
        void 0 === s && (s = OrgChart.icon[l](24, 24, "#7A7A7A")), r += '<div data-item="' + l + '" style="border-bottom: 1px solid #D7D7D7; padding: 7px 10px;color: #7A7A7A;">' + s + "<span>&nbsp;&nbsp;" + h + "</span></div>"
    }
    if ("" != r) {
        ...
        for (var g = this.wrapper.getElementsByTagName("div"), p = 0; p < g.length; p++) {
            (l = g[p]).addEventListener("mouseover", function () {
                this.style.backgroundColor = "#F0F0F0"
            }), l.addEventListener("mouseleave", function () {
                this.style.backgroundColor = "#FFFFFF"
            }), l.addEventListener("click", function () {
                var t = this.getAttribute("data-item");
                if (void 0 === o[t].onClick)
                    if ("add" === t) {
                        var e = {
                        ...
                        var r = n.obj.getBGNode(i);
                        n.obj.editUI.show(r.id)
                    } else if ("details" === t) {
                        r = n.obj.getBGNode(i);
                        n.obj.editUI.show(r.id, !0)
                    } else "remove" === t ? n.obj.removeNode(i, !0) : "svg" === t ? n.obj.exportSVG({
                        filename: "OrgChart.svg",
                        expandChildren: !1,
                        nodeId: i
                    }) : "pdf" === t ? n.obj.exportPDF({
                        filename: "OrgChart.pdf",
                        expandChildren: !1,
                        nodeId: i
                    }) : "png" === t ? n.obj.exportPNG({
                        filename: "OrgChart.png",
                        expandChildren: !1,
                        nodeId: i
                    }) : "csv" === t ? n.obj.exportCSV() : "addInGroup" === t ? n.obj.group(i, a) : "addAsChild" === t && n.obj.linkNode(i, a);
                else o[t].onClick.call(n.obj, i, a);
                n.hide()
            })
        }
    }
    ...
    if (this.obj = t, this.toolbar = e) {
        this._visible = !1, this.div = document.createElement("div"), Object.assign(this.div.style, {
            position: "absolute",
            padding: "3px",
    ...
    return '<svg width="' + t + '" height="' + e + '" viewBox="0 0 922 922"><path fill="' + r + '" d="M922,453V81c0-11.046-8.954-20-20-20H410c-11.045,0-20,8.954-20,20v149h318c24.812,0,45,20.187,45,45v198h149 C913.046,473.001,922,464.046,922,453z" /><path fill="' + r + '" d="M557,667.001h151c11.046,0,20-8.954,20-20v-174v-198c0-11.046-8.954-20-20-20H390H216c-11.045,0-20,8.954-20,20v149h194 h122c24.812,0,45,20.187,45,45v4V667.001z" /><path fill="' + r + '" d="M0,469v372c0,11.046,8.955,20,20,20h492c11.046,0,20-8.954,20-20V692v-12.501V667V473v-4c0-11.046-8.954-20-20-20H390H196 h-12.5H171H20C8.955,449,0,457.955,0,469z" /></svg>'
}, OrgChart.prototype.exportPDF = function (t) {
    t.mime = "application/pdf", t.ext = "pdf", this._export(t)
}, OrgChart.prototype.exportPNG = function (t) {
    t.mime = "image/png", t.ext = "png", this._export(t)
}, OrgChart.prototype.exportSVG = function (t) {
    t.ext = "svg", t.mime = "image/svg+xml", this._export(t)
}, OrgChart.prototype._export = function (n) {
    var l = this;
    if (n.filename || (n.filename = "OrgChart." + n.ext), null != n.nodeId) {
        var t = this.getBGNode(n.nodeId);
        t.isChildOfGroup && (n.nodeId = t._groupParentNodeId)
    }
    var e = {
        id: n.nodeId,
        expandChildren: n.expandChildren
    };
    this._draw(!1, OrgChart.action.exporting, e, function (t) {
        var o = document.createElement("div");
        if (o.innerHTML = t, "svg" == n.ext) {
            if (l.config.onExportEnd)
                if (!1 === l.config.onExportEnd(l, n, o.innerHTML)) return !1;
            OrgChart._downloadFile(n.mime, o.innerHTML, n.filename)
        } else {
            if (null == n.margin && (n.margin = {
                top: "20px",
                bottom: "20px",
                left: "20px",
                right: "20px"
            }), null == n.landscape && (n.landscape = !1), null == n.width) {
                var e = o.querySelector("svg").getAttribute("width");
                n.width = e
            }
            if (null == n.height) {
                var r = o.querySelector("svg").getAttribute("height");
                if (n.height = parseFloat(r), n.margin) {
                    var i = parseFloat(n.margin.bottom);
                    n.height += i
                }
                n.height += 5
            }
            null == n.extraHtml && (n.extraHtml = ""), OrgChart._imgs2base64(o, "image", "xlink:href", function () {
                if ("pdf" == n.ext && "A4" == n.format) {
                    var t = n.landscape ? OrgChart.A4h : OrgChart.A4w,
                        e = o.querySelector("svg"),
                        r = parseFloat(e.getAttribute("width")),
                        i = 652;// parseFloat(e.getAttribute("height"));
                     //Make Height static
                    //i /= r / t, 
                        e.setAttribute("width", t), e.setAttribute("height", i),
                        e.style.margin = "0 auto", e.setAttribute("preserveAspectRatio", "xMidYMin meet")
                }
                if (l.config.onExportStart && !1 === l.config.onExportStart(l, n, o.querySelector("svg"))) return !1;
                var a = {
                    content: '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head><body style="margin:0;padding:0;">' + n.extraHtml + o.innerHTML + "</body></html>",
                    options: n
                };
                
                a = JSON.stringify(a), OrgChart._ajax(l.config.exportUrl + "/v1", "POST", a, "arraybuffer", function (t) {
                    if (l.config.onExportEnd && !1 === l.config.onExportEnd(l, n, t)) return !1;
                    OrgChart._downloadFile(n.mime, t, n.filename)
                })
            })
        }
    })
}, OrgChart.prototype.exportCSV = function (t) {
    if ((t || (t = "OrgChart.csv"), this.config.onExportStart) && !1 === this.config.onExportStart(this, "csv", t)) return !1;
    var e = this.server.convertToCSVdata();
    if (this.config.onExportEnd && !1 === this.config.onExportEnd(this, "csv", t, e)) return !1;
    ...
    this.nodeMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var e = this.getBGNode(t);
    if (e.collapsedChildrenIds.length) {
        if (this.config.onExpCollClick)
            if (!1 === this.config.onExpCollClick(this, OrgChart.EXPAND, t, e.collapsedChildrenIds)) return !1;
        this.expand(t, e.collapsedChildrenIds, !1)
    } else {
        if (this.config.onExpCollClick)
            if (!1 === this.config.onExpCollClick(this, OrgChart.COLLAPSE, t, e.childrenIds)) return !1;
    ...
    if (e.groupState == OrgChart.EXPAND) {
        if (this.config.onExpCollClick)
            if (!1 === this.config.onExpCollClick(this, OrgChart.COLLAPSE, t)) return !1;
        this.minimize(t)
    } else if (e.groupState == OrgChart.COLLAPSE) {
        if (this.config.onExpCollClick)
            if (!1 === this.config.onExpCollClick(this, OrgChart.EXPAND, t)) return !1;
        this.maximize(t)
    }
    ...
    if (this.config.enableDragDrop) {
        ...
        var h = this,
            ...
            g = OrgChart._getTransform(t),
            p = g[4],
            f = g[5],
            u = h.getScale(),
            C = t.cloneNode(!0);
        if (d.insertBefore(C, d.firstChild), C.style.opacity = .7, o.isChildOfGroup) {
            var n = this.getNodeElement(o._groupParentNodeId),
                m = OrgChart._getTransform(n);
            p += m[4], f += m[5], g[4] = p, g[5] = f, C.setAttribute("transform", "matrix(" + g.toString() + ")")
        }
        var O = function (t) {
            var e, r = OrgChart._getClientXY(t),
                i = document.elementFromPoint(r.x, r.y);
            if (null != l && ((e = h.getBGNode(l)).isChildOfGroup ? (h.getNodeElement(e._groupParentNodeId).style.opacity = 1, s.style.opacity = 1) : e.isGroup || (s.style.opacity = 1)), s = l = null, h.config.enableDragDrop)
                for (; null != i && i != d;) {
                    if (i.hasAttribute("node-id")) {
                        var a = i.getAttribute("node-id");
                        if (h._gragStartedId && a != h._gragStartedId) {
                            l = a, s = i;
                            break
                        }
                    }
            ...
            null != l && ((e = h.getBGNode(l)).isChildOfGroup ? (h.getNodeElement(e._groupParentNodeId).style.opacity = .8, s.style.opacity = .5) : e.isGroup ? s = l = null : s.style.opacity = .5);
            var o = (r.x - c.x) / u,
                n = (r.y - c.y) / u;
            g[4] = p + o, g[5] = f + n, C.setAttribute("transform", "matrix(" + g.toString() + ")")
        },
            x = function (t) {
                if (d.removeEventListener(i.move, O), d.removeEventListener(i.up, x), i.leave && d.removeEventListener(i.leave, x), o.id == l || o.isChildOfGroup && o._groupParentNodeId == l || null == l) return d.removeChild(C), void (h._gragStartedId = null);
                var e = h.getBGNode(l);
                if (null == h.config.dragDropMenu || o.isGroup && !e.isGroup) h._canUpdateLink(o.id, l) ? h.linkNode(o.id, l) : d.removeChild(C);
                else if (h._canUpdateLink(o.id, l)) {
                    var r = OrgChart._getOffsetXY(h.element, t);
                    h.dragDropMenuUI.show(r.x, r.y, o.id, l)
                } else d.removeChild(C);
                h._gragStartedId = null
            };
        d.addEventListener(i.move, O), d.addEventListener(i.up, x), i.leave && d.addEventListener(i.leave, x)
    }
    ...
    if (this.config.onDbClick && !1 === this.config.onDbClick(this, this.get(t))) return !1;
    this._commonClickHandler(t, e, this.config.nodeMouseDbClick)
}, OrgChart.prototype._nodeClickHandler = function (t, e) {
    if (this.config.onClick && !1 === this.config.onClick(this, this.get(t))) return !1;
    this._commonClickHandler(t, e, this.config.nodeMouseClick)
}, OrgChart.prototype._commonClickHandler = function (t, e, r) {
    this.searchUI.hide(), this.nodeMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var i = this.getBGNode(t);
    if (r == OrgChart.action.expandCollapse) {
        if (i.collapsedChildrenIds.length) {
            if (this.config.onExpCollClick)
                if (!1 === this.config.onExpCollClick(this, OrgChart.EXPAND, t, i.collapsedChildrenIds)) return !1;
            this.expand(t, i.collapsedChildrenIds, !1)
        } else {
            if (this.config.onExpCollClick)
                if (!1 === this.config.onExpCollClick(this, OrgChart.COLLAPSE, t, i.childrenIds)) return !1;
    ...
    if (Array.isArray(a.tags))
        for (var n = 0; n < a.tags.length; n++) {
            var l = a.tags[n];
            this.config.tags[l] && this.config.tags[l].nodeMenu && (o = this.config.tags[l].nodeMenu)
        }
    this.nodeMenuUI.show(i.x, i.y, t, null, o)
}, OrgChart.prototype._exportMenuClickHandler = function (t, e) {
    e.stopPropagation(), e.preventDefault(), this.nodeMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.show(t.offsetLeft, t.offsetTop)
    ...
    var o = OrgChart.t(this.templateName);
    this.w = o && o.size ? o.size[0] : 0, this.h = o && o.size ? o.size[1] : 0, this.groupState = OrgChart.EXPAND, this.isChildOfGroup = !1, this.isGroup = !1, this._groupParentNodeId = null, this._groupSettings = null, this.bgnodes = []
}, OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    var s = this;
    document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none", this.editUI.hide(), this.searchUI.hide(), this.nodeMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    ...
    var p = function (t) {
        ...
        f = function () {
            "pan" == c.type && OrgChart._moveToBoundaryArea(t, s.getViewBox(), s.response.boundary, function () {
                s._draw(!0, OrgChart.action.pan)
            }), c = null, o.style.display = "none", t.removeEventListener(r.move, p), t.removeEventListener(r.up, f), r.leave && t.removeEventListener(r.leave, f), r.touchstart && t.removeEventListener(r.touchstart, f)
        };
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.local = {}, OrgChart.local._walk = function (t, e, r) {
    for (var i = [], a = [], o = [], n = 0; n < t.length; n++) OrgChart.local._firstWalk(t[n], 0, i, a, o, e), OrgChart.local._secondWalk(t[n], 0, 0, 0, i, a, e);
    r()
}, OrgChart.local._firstWalk = function (t, e, r, i, a, o) {
    var n = null;
    if (t.x = 0, t.y = 0, t._prelim = 0, t._modifier = 0, t.level = e, t.leftNeighbor = null, t.rightNeighbor = null, OrgChart.local._setLevelHeight(t, e, r), OrgChart.local._setLevelWidth(t, e, i), OrgChart.local._setNeighbors(t, e, a), 0 == OrgChart.local._getChildrenCount(t) || e == OrgChart.MAX_DEPTH)
        if (null != (n = OrgChart.local._getLeftSibling(t))) {
            var l = o.siblingSeparation;
            2 == n.layout && (l = o.mixedHierarchyNodesSeparation), t._prelim = n._prelim + OrgChart.local._getNodeWidth(n, o) + l
        } else t._prelim = 0;
    else {
        for (var s = OrgChart.local._getChildrenCount(t), h = 0; h < s; h++) {
            var d = OrgChart.local._getChildAt(t, h);
            OrgChart.local._firstWalk(d, e + 1, r, i, a, o)
        }
        var c = OrgChart.local._getFirstChild(t),
            g = OrgChart.local._getLastChild(t),
            p = c._prelim + (g._prelim - c._prelim + OrgChart.local._getNodeWidth(g, o)) / 2;
        if (p -= OrgChart.local._getNodeWidth(t, o) / 2, null != (n = OrgChart.local._getLeftSibling(t))) {
            l = o.siblingSeparation;
            2 == n.layout && (l = o.mixedHierarchyNodesSeparation), t._prelim = n._prelim + OrgChart.local._getNodeWidth(n, o) + l, t._modifier = t._prelim - p, OrgChart.local._apportion(t, e, o)
        } else o.orientation <= 3 ? t._prelim = p : t._prelim = 0
    }
}, OrgChart.local._secondWalk = function (t, e, r, i, a, o, n) {
    if (e <= OrgChart.MAX_DEPTH) {
        var l = t._prelim + r,
            s = i,
            h = 0,
            d = 0,
        ...
        if (t.x = l, t.y = s, ("split" == t.templateName || t.isAssistant || 2 == t.layout) && (t.y = s + h / 2 - d / 2), c) {
            var g = t.x;
            t.x = t.y, t.y = g
        }
        switch (n.orientation) {
        ...
        if (0 != OrgChart.local._getChildrenCount(t)) {
            var p = n.levelSeparation;
            t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (p = n.mixedHierarchyNodesSeparation), OrgChart.local._secondWalk(OrgChart.local._getFirstChild(t), e + 1, r + t._modifier, i + h + p, a, o, n)
        }
        var f = OrgChart.local._getRightSibling(t);
        null != f && OrgChart.local._secondWalk(f, e, r, i, a, o, n)
    }
}, OrgChart.local._apportion = function (t, e, r) {
    for (var i = OrgChart.local._getFirstChild(t), a = i.leftNeighbor, o = 1, n = OrgChart.MAX_DEPTH - e; null != i && null != a && o <= n;) {
        for (var l = 0, s = 0, h = i, d = a, c = 0; c < o; c++) h = h.parent, d = d.parent, l += h._modifier, s += d._modifier;
        var g = r.subtreeSeparation;
        t.leftNeighbor && 2 == t.leftNeighbor.layout && (g = 0);
        var p = a._prelim + s + OrgChart.local._getNodeWidth(a, r) + g - (i._prelim + l);
        if (0 < p) {
            for (var f = t, u = 0; null != f && f != d; f = OrgChart.local._getLeftSibling(f)) u++;
            if (null != f)
                for (var C = t, m = p / u; C != d; C = OrgChart.local._getLeftSibling(C)) C._prelim += p, C._modifier += p, p -= m
        }
        o++ , null != (i = 0 == OrgChart.local._getChildrenCount(i) ? OrgChart.local._getLeftmost(t, 0, o) : OrgChart.local._getFirstChild(i)) && (a = i.leftNeighbor)
    }
}, OrgChart.local._setLevelHeight = function (t, e, r) {
    null == r[e] && (r[e] = 0), r[e] < t.h && (r[e] = t.h)
}, OrgChart.local._setLevelWidth = function (t, e, r) {
    null == r[e] && (r[e] = 0), r[e] < t.w && (r[e] = t.w)
}, OrgChart.local._setNeighbors = function (t, e, r) {
    r[e] && r[e].id === t.id || (t.leftNeighbor = r[e], null != t.leftNeighbor && (t.leftNeighbor.rightNeighbor = t), r[e] = t)
}, OrgChart.local._getChildrenCount = function (t) {
    return t.children.length
}, OrgChart.local._getChildAt = function (t, e) {
    return t.children[e]
}, OrgChart.local._getFirstChild = function (t) {
    return OrgChart.local._getChildAt(t, 0)
}, OrgChart.local._getLastChild = function (t) {
    return OrgChart.local._getChildAt(t, t.children.length - 1)
}, OrgChart.local._getNodeWidth = function (t, e) {
    ...
    if (r <= e) return t;
    if (0 == OrgChart.local._getChildrenCount(t)) return null;
    for (var i = OrgChart.local._getChildrenCount(t), a = 0; a < i; a++) {
        var o = OrgChart.local._getChildAt(t, a),
            n = OrgChart.local._getLeftmost(o, e + 1, r);
        if (null != n) return n
    }
    return null
    ...
    var o = function () {
        ...
        l = function () {
            var t = i.querySelector('[data-selected="yes"]').getAttribute("data-search-item-id"),
                e = !0;
            r.obj.config.onSearchClick && (e = r.obj.config.onSearchClick(r.obj, t)), null != e && 1 != e || r.obj.center(t)
        }
    ...
    for (n = 0; n < h.length; n++) h[n].addEventListener("click", function () {
        var t = !0;
        e.obj.config.onSearchClick && (t = e.obj.config.onSearchClick(e.obj, this.getAttribute("data-search-item-id"))), null != t && 1 != t || e.obj.center(this.getAttribute("data-search-item-id"))
    ...
    return '<div  id="divSearch"  data-id="search" style="display:none;border-radius: 20px 20px;padding:5px; box-shadow: #808080 0px 1px 2px 0px; font-family:Roboto-Regular, Helvetica;color:#7a7a7a;font-size:14px;border:1px solid #d7d7d7;width:300px;position:absolute;top:' + t + "px;left:" + t + 'px;background-color:#ffffff;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32) + '</div><div data-id="cell-1" style="float:right; width:83%"><input placeholder="Search" style="font-size:14px;font-family:Roboto-Regular, Helvetica;color:#7a7a7a;width:100%;border:none;outline:none; padding-top:10px;" type="text" /></div><div style="clear:both;"></div></div><div data-id="container"></div></div>'
}, OrgChart.searchUI.createItem = function (t, e) {
    //if (e.node.id.data.supervisorFlag == 0)
    //{ return ''; }
     
    //Default text width is 83% and float right i changed it to 95% and 
    return '<div data-search-item-id="' + e.id + '" style="border-top:1px solid #d7d7d7; padding: 7px 0 7px 0;cursor:pointer;"><div style="float:left;">' + t + '</div><div style="float:right; width:95%"><div style="overflow:hidden; white-space: nowrap;text-overflow:ellipsis;text-align:left;">' + e.textId + '</div><div style="overflow:hidden; white-space: nowrap;text-overflow:ellipsis;text-align:left;">' + e.textInNode + '</div></div><div style="clear:both;"></div></div>'
}, OrgChart.searchUI.createSearchIcon = function (t) {
    return '<div  id="divSearchIcon"  data-id="search-icon" style="padding:5px; position:absolute;top:' + t + "px;left:" + t + 'px;border:1px solid transparent;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32) + "</div></div></div>"
...
}, OrgChart.server.prototype.read = function (t, r, i, e, a, o, n) {
    var l = this;
    ...
    var s = this.maxX,
        ...
        g = this.root,
        p = this.nodes,
        f = this.groupChildren;
    if (t) {
        var u = OrgChart.server._getResponse(r, i, this.visibleNodes, this.config, s, h, d, c, this.viewBox, g, this.action, this.actionParams, p, f, this.oldNodes);
        a != OrgChart.action.exporting && (this.maxX = s, this.maxY = h, this.minX = d, this.minY = c, this.root = g, this.nodes = p, this.groupChildren = f, this.visibleNodes = u.visibleNodes), n(u)
    } else this.oldNodes = p || null, this._read(function (t) {
        s = t.maxX, h = t.maxY, d = t.minX, c = t.minY, g = t.roots[0], p = t.nodes, f = t.groupChildren;
        var e = OrgChart.server._getResponse(r, i, l.visibleNodes, l.config, s, h, d, c, l.viewBox, g, l.action, l.actionParams, p, f, l.oldNodes);
        e.notif = t.limit, a != OrgChart.action.exporting && (l.maxX = s, l.maxY = h, l.minX = d, l.minY = c, l.root = g, l.nodes = p, l.groupChildren = f, l.visibleNodes = e.visibleNodes), n(e)
    })
}, OrgChart.server.prototype._read = function (a) {
    var o = this,
        n = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes),
        l = n.nodes,
        s = n.roots,
        t = OrgChart.remote;
    null == t && (t = OrgChart.local), t._walk(s, this.config, function (t) {
        OrgChart.server._doNotChangePositionOfClickedNodeIfAny(l, o.action, o.actionParams, o.oldNodes, o.config.orientation);
        var e = {
            minX: null,
            minY: null,
            maxX: null,
    ...
    for (var o = [], t = function (t) {
        ...
        return e + "\n"
    }, e = "", r = 0; r < this.config.nodes.length; r++)
        for (var i in this.config.nodes[r]) OrgChart._arrayContains(o, i) || (o.push(i), e += i + ",");
    e += "\n";
    for (r = 0; r < this.config.nodes.length; r++) e += t(this.config.nodes[r]);
    return e
    ...
    for (var e, i, a, o = function (t) {
        ...
        for (var d in h) {
            var c = h[d];
            0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d) || c && -1 != c.toString().toLowerCase().indexOf(t) && !OrgChart._fieldIsImg(this.config, d) && n.push({
                id: h.id,
                propertyName: d,
                isId: d == OrgChart.ID,
                isNodeParam: o(d),
                weight: c.toString().toLowerCase().indexOf(t),
                data: h
            })
        }
    }
        ...
        for (var g = !1, p = 0; p < l.length; p++)
            if (l[p].id == n[s].id) {
                ...
                for (p = 0; p < O.length; p++) {
                    d = O[p], c = n[s].data[d];
                    d === n[s].propertyName && (i = t, void 0, a = (e = c).toString().toLowerCase().indexOf(i), c = e.toString().splice(a + i.length, 0, "</mark>").splice(a, 0, "<mark>")), d != OrgChart.TAGS && (d == OrgChart.ID ? u = u + c + ", " : OrgChart._fieldIsImg(this.config, d) ? m = c : o(d) && !OrgChart._fieldIsImg(this.config, d) ? f = f + c + ", " : OrgChart._fieldIsImg(this.config, d) || (C = C + c + ", "))
                }
                u = u.slice(0, u.length - 2), f = f.slice(0, f.length - 2), C = C.slice(0, C.length - 2);
                var x = OrgChart._getTemplate(n[s].tags, this.config.tags, this.config.template);
                l.push({
                    id: n[s].id,
                    node: new OrgChart.node(n[s], null, null, [], x),
                    textId: u,
                    textInNode: f,
                    text: C,
                    img: m
    ...
    for (var a = t.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        ...
        if ((y = new OrgChart.node(g.id, g.pid, C, p, u)).isAssistant = -1 != p.indexOf("assistant"), y.isAssistant && -1 == s.indexOf(y.pid) && s.push(y.pid), null != f) {
            if (!o[f.name]) {
                ...
                m.isGroup = !0, null != t.orderBy && (m.order = g[t.orderBy]), o[f.name] = m
            }
            y.isChildOfGroup = !0, y._groupParentNodeId = f.name, o[f.name].bgnodes.push(y), h[y.id] = f.name, d = !0
        } else null != t.orderBy && (y.order = g[t.orderBy]), o[g.id] = y, n.push(g.id)
    }
    ...
    for (c = 0; c < n.length; c++) {
        var x = n[c],
            y = o[x],
            v = i ? i[x] : null;
        if (null != y.pid && null != y.pid && "" != y.pid) (w = o[y.pid]) ? ((y.parent = w).children.push(y), w.childrenIds.push(y.id)) : (y.pid = null, y.parent = null, l.push(y));
        else l.push(y);
        e == OrgChart.action.exporting && null != r.id && (l = [o[r.id]]), v ? (y.state = v.state, y.state == OrgChart.COLLAPSE && O.push(y.id), OrgChart.server._setNodeGroupState(y, v.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(y, OrgChart.EXPAND, t.orientation), OrgChart.server._initStates(y, o, e, t, r, h, O), OrgChart.server._initGroupStates(y, o, e, t, r)
    }
    if (null != t.roots) {
        l = [];
    ...
    for (c = 0; c < s.length; c++) {
        var w = o[s[c]],
            _ = new OrgChart.node(w.id + "_split_0", w.id, null, [], "split");
        (v = i[(o[_.id] = _).id]) && (o[_.id].state = v.state, o[_.id].state == OrgChart.COLLAPSE && O.push(_.id)), OrgChart.server._initStates(_, o, e, t, r, h, O);
        for (var k = [], N = w.children.length - 1; 0 <= N; N--) {
            (U = w.children[N]).isAssistant ? (U.parent = null, w.children.splice(N, 1), w.childrenIds.splice(N, 1), k.splice(0, 0, U.id)) : (U.pid = _.id, (U.parent = _).children.push(U), _.childrenIds.push(U.id), w.children.splice(N, 1))
        }
        if (k.length % 2) {
            var S = o[k[k.length - 1]],
                A = OrgChart.t(S.templateName),
                I = "transperant_" + S.templateName;
            OrgChart.templates[I] = {
                ...
                nodeMenuButton: "",
                size: A.size
            }, (J = new OrgChart.node(w.id + "_transperant", S.pid, null, [], I)).isAssistant = !0, (v = i[(o[J.id] = J).id]) && (o[J.id].state = v.state, o[J.id].state == OrgChart.COLLAPSE && O.push(J.id)), OrgChart.server._initStates(J, o, e, t, r, h, O), k.splice(k.length - 1, 0, J.id)
        }
        var E = 1;
        for (N = k.length - 1; 0 <= N; N--)
            if (N % 2 && N != k.length - 1) {
                var M = new OrgChart.node(w.id + "_split_" + E, null, null, [], "split");
                (v = i[(o[M.id] = M).id]) && (o[M.id].state = v.state, o[M.id].state == OrgChart.COLLAPSE && O.push(M.id)), OrgChart.server._initStates(M, o, e, t, r, h, O), k.splice(N, 0, M.id), E++
            } else N % 2 && k.splice(N, 0, _.id);
        for (N = 0; N < k.length; N += 3) {
            ...
            var B = o[k[N]],
                T = o[k[N + 1]],
                P = o[k[N + 2]];
            B.parent = L, B.pid = L.id, T.parent = L, T.pid = L.id, P.parent = L, P.pid = L.id, L.children.push(B), L.children.push(T), L.children.push(P), L.childrenIds.push(B.id), L.childrenIds.push(T.id), L.childrenIds.push(P.id);
            for (var H = L;
                "split" == H.templateName && (H = H.parent);) H.childrenIds.push(B.id), H.childrenIds.push(T.id), H.childrenIds.push(P.id)
        }
    }
    if (e == OrgChart.action.centerNode) {
        var z = o[r.id];
        z || (z = o[h[r.id]], OrgChart.server._setNodeGroupState(z, OrgChart.EXPAND, t.orientation)), z.state = OrgChart.EXPAND, -1 != (G = O.indexOf(z.id)) && O.splice(G, 1);
        w = OrgChart.server._getRealParent(z);
        for (var j = z.id; null != w;) {
            if (-1 != (G = O.indexOf(w.id)) && O.splice(G, 1), w.state = OrgChart.EXPAND, r.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < w.childrenIds.length; c++) {
                    var U = o[w.childrenIds[c]];
                    if (!OrgChart.server._isSplit(U) && !U.isAssistant && U.id != j) - 1 == (G = O.indexOf(w.childrenIds[c])) && O.push(w.childrenIds[c]), U.state = OrgChart.COLLAPSE
                }
            if (w.state == OrgChart.EXPAND)
                for (var F = 0; F < w.childrenIds.length; F++) {
                    var D = o[w.childrenIds[F]];
                    if (OrgChart.server._isSplit(D) || D.isAssistant) - 1 != (G = O.indexOf(D.id)) && O.splice(G, 1), D.state = OrgChart.EXPAND
                }
            j = w.id, w = OrgChart.server._getRealParent(w)
        }
        if (r.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < z.childrenIds.length; c++) {
                if (-1 != (G = O.indexOf(z.childrenIds[c])) && O.splice(G, 1), (U = o[z.childrenIds[c]]).state = OrgChart.EXPAND, !U.isAssistant && !OrgChart.server._isSplit(U))
                    for (N = 0; N < U.childrenIds.length; N++) {
                        var G, X = o[U.childrenIds[N]]; - 1 == (G = O.indexOf(U.childrenIds[N])) && O.push(U.childrenIds[N]), X.state = OrgChart.COLLAPSE
                    }
            }
    }
    ...
    for (c = 0; c < O.length; c++) {
        if (w = (y = o[O[c]]).parent)
            for (N = w.children.length - 1; 0 <= N; N--) {
                if (w.children[N] == y)
                    if (-1 == w.collapsedChildrenIds.indexOf(y.id) && w.collapsedChildrenIds.push(y.id), w.children.splice(N, 1), "split" == y.templateName || "split" == w.templateName) {
                        if (L = y.parent) {
                            for (;
                                "split" == L.templateName;) L = L.parent;
                            for (var R = 0; R < L.childrenIds.length; R++) {
                                var Y = L.childrenIds[R]; - 1 == L.collapsedChildrenIds.indexOf(Y) && L.collapsedChildrenIds.push(Y)
                            }
                        }
                    } else y.parent = null
            }
    ...
    if (t.layout == OrgChart.mixed)
        for (c = 0; c < n.length; c++) {
            if (0 == (y = o[n[c]]).childrenIds.length && !y.isAssistant && "split" != y.templateName)
                if (w = y.parent)
                    for (N = w.children.length - 1; 0 <= N; N--) {
                        if ((U = w.children[N]) != y && 0 == U.childrenIds.length && !U.isAssistant && "split" != U.templateName) {
                            U.parent = y, U.pid = y.id, U.layout = OrgChart.mixed, w.children.splice(N, 1);
                            var V = y.children.length;
                            y.children[V] = U, y.layout = OrgChart.mixed
                        }
                    }
        }
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        var q = [];
        for (c = 0; c < n.length; c++) {
            if (0 == (y = o[n[c]]).childrenIds.length && !y.isAssistant && "split" != y.templateName) (w = y.parent) && -1 == q.indexOf(w.id) && q.push(w.id)
        }
        for (c = 0; c < q.length; c++) {
            w = o[q[c]], _ = new OrgChart.node(w.id + "_split_0", w.id, null, [], "split");
            (o[_.id] = _).layout = OrgChart.tree;
            var W = [];
            for (N = w.children.length - 1; 0 <= N; N--) {
                if (0 == (U = w.children[N]).childrenIds.length && !U.isAssistant && "split" != U.templateName && U.parent && "split" != U.parent.templateName) {
                    if ((U = w.children[N]).parent = null, U.layout = OrgChart.tree, w.children.splice(N, 1), w.childrenIds.splice(N, 1), t.layout == OrgChart.treeRightOffset && W.splice(0, 0, U.id), t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                        var J;
                        I = "transperant_" + U.templateName;
                        OrgChart.templates[I] = {
                            linkAdjuster: {},
                            link: "",
                            node: "",
                            nodeMenuButton: "",
                            size: [0, 0]
                        }, (J = new OrgChart.node(U.id + "_transperant", null, null, [], I)).layout = OrgChart.tree, o[J.id] = J, W.splice(0, 0, J.id)
                    }
                    t.layout != OrgChart.treeRightOffset && W.splice(0, 0, U.id)
                }
            }
            for (E = 1, N = W.length - 1; 0 <= N; N--) {
                if (N % 2 && N != W.length - 1) (M = new OrgChart.node(w.id + "_split_" + E, null, null, [], "split")).layout = OrgChart.tree, o[M.id] = M, W.splice(N, 0, M.id), E++;
                else N % 2 && W.splice(N, 0, _.id)
            }
            for (N = 0; N < W.length; N += 3) {
                L = null;
                0 == N && (L = w);
                B = o[W[N]], T = o[W[N + 1]], P = o[W[N + 2]];
                0 != N && (L = o[W[N - 3]]), 0 == N || T || (L = o[W[N - 2]]), B.parent = L, B.pid = L.id, L.children.push(B), w.childrenIds.push(B.id), T && (0 != N && (L = o[W[N - 2]]), T.parent = L, T.pid = L.id, L.children.push(T), w.childrenIds.push(T.id)), P && (0 != N && (L = o[W[N - 1]]), P.parent = L, P.pid = L.id, L.children.push(P), w.childrenIds.push(P.id))
            }
        }
    }
    return {
    ...
    return e
}, OrgChart.server._initStates = function (t, e, r, i, a, o, n) {
    if (r == OrgChart.action.init && t) {
        if (t.tags)
            for (var l = 0; l < t.tags.length; l++) {
                var s = t.tags[l];
                i.tags && i.tags[s] && null != i.tags[s].state && (i.tags[s].state == OrgChart.COLLAPSE && n.push(t.id), t.state = i.tags[s].state)
            }
        if (i.collapse.level) {
            for (var h = 0, d = e[t.pid]; null != d && h <= i.collapse.level;) d = e[d.pid], h++;
            if (h >= i.collapse.level) {
                var c = !1;
                if (Array.isArray(i.expand.nodes))
                    if (i.expand.allChildren) {
                        for (d = e[t.pid]; null != d;) {
                            if (-1 != i.expand.nodes.indexOf(d.id)) {
                                c = !0;
                                break
                            }
                            d = e[d.pid]
                        }
                        c || (c = -1 != i.expand.nodes.indexOf(t.id))
                    } else c = -1 != i.expand.nodes.indexOf(t.id);
                !c && i.collapse.allChildren ? (n.push(t.id), t.state = OrgChart.COLLAPSE) : c || i.collapse.allChildren || h != i.collapse.level || (n.push(t.id), t.state = OrgChart.COLLAPSE)
            }
        }
        ...
        if (a.state == OrgChart.COLLAPSE) n.push(t.id);
            ...
            var g = n.indexOf(t.id); - 1 != g && n.splice(g, 1)
        }
        t.state = a.state
    }
    ...
    return e
}, OrgChart.server._doNotChangePositionOfClickedNodeIfAny = function (t, e, r, i, a) {
    if ((e == OrgChart.action.expandCollapse || e == OrgChart.action.groupMaxMin || e == OrgChart.action.centerNode || e == OrgChart.action.update || e == OrgChart.action.insert) && (e != OrgChart.action.update || r && null != r.id) && null != r.id) {
        var o = r.id;
        e == OrgChart.action.groupMaxMin && t[o].pid && (o = t[o].pid);
        var n = t[o];
        if (!n)
            for (var l in t)
                for (var s = t[l].bgnodes, h = 0; h < s.length; h++)
                    if (s[h].id == o) {
                        n = t[l];
                        break
                    } var d = i[o];
        if (!d)
            for (var l in i)
                for (s = i[l].bgnodes, h = 0; h < s.length; h++)
                    if (s[h].id == o) {
                        d = i[l];
                        break
                    } var c = d.x - n.x,
                        g = d.y - n.y;
        for (var o in t) switch (a) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
    ...
    var u = {},
        ...
        O = a - n + 2 * i.padding,
        x = o - l + 2 * i.padding,
        y = OrgChart.getScale(s, t, e, i.scaleInitial, O, x);
    if (C.top = l - i.padding, C.left = n - i.padding, C.bottom = o + i.padding - e / y, C.right = a + i.padding - t / y, C.maxX = a, C.minX = n, C.maxY = o, C.minY = l, null == s && i.align == OrgChart.CENTER) {
        var v = Math.ceil(t / y),
            ...
            w = 0,
            _ = 0;
        if (v - 2 * i.padding >= a - n) switch (w = (a + n) / 2 - v / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                w = (n - a) / 2 - v / 2
        } else switch (w = h.x - v / 2 + OrgChart.server._getNodeWidth(h, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                (w = -(v / 2 - (n - a) / 2)) < i.padding - v && (w = i.padding - v);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.bottom_left:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.left_top:
                (w = -(v / 2 - (a - n) / 2)) > -i.padding && (w = -i.padding)
        }
        ...
        v = Math.ceil(t / y), b = Math.ceil(e / y), w = 0, _ = 0;
        switch (i.orientation) {
            case OrgChart.orientation.top:
                w = h.x - v / 2 + OrgChart.server._getNodeWidth(h, i) / 2, _ = -i.padding;
                break;
            case OrgChart.orientation.bottom:
                w = h.x - v / 2 + OrgChart.server._getNodeWidth(h, i) / 2, _ = i.padding - b;
                break;
            case OrgChart.orientation.left:
                w = -i.padding, _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
                break;
            case OrgChart.orientation.right:
                w = i.padding - v, _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
                break;
            case OrgChart.orientation.top_left:
                w = -i.padding, _ = -i.padding;
                break;
            case OrgChart.orientation.right_top:
                w = i.padding - v, _ = -i.padding;
                break;
            case OrgChart.orientation.left_top:
                w = -i.padding, _ = -i.padding;
                break;
    ...
    d == OrgChart.action.centerNode && ((B = g[c.id]) || (B = g[p[c.id]]), s[0] = B.x + B.w / 2 - s[2] / 2, s[1] = B.y + B.h / 2 - s[3] / 2, s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left), s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right), s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top), s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom));
    if (d == OrgChart.action.insert || d == OrgChart.action.expandCollapse || d == OrgChart.action.update) {
        var k = null;
        if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId ? (k = g[c.insertedNodeId]) || (k = g[p[c.insertedNodeId]]) : d == OrgChart.action.update && c && null != c.visId && null != c.visId ? (k = g[c.visId]) || (k = g[p[c.visId]]) : d == OrgChart.action.expandCollapse && c && null != c.id && null != c.id && ((k = g[c.id]) || (k = g[p[c.id]]), k = OrgChart.server._getMostDeepChild(k, g)), k) switch (i.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
                var N = k.y + k.h - s[3] + i.padding;
                s[1] < N && (s[1] = N);
                break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
            ...
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                N = k.x + k.w - s[2] + i.padding;
                s[0] < N && (s[0] = N)
        }
    }
    for (var S in g) {
        var A = g[S];
        if (OrgChart.server._isVisible(A, i, s, d)) {
            u[A.id] = A;
            var I = null;
            if (d == OrgChart.action.expandCollapse && f && f[A.id]) {
                if (I = {
                    x: (T = f[A.id]).x,
                    y: T.y
                }, "all" == c.ids && T) {
                    ...
                    for (var E = A, M = null; null != E;) f[E.id] && f[E.id].state == OrgChart.COLLAPSE && (M = E), E = E.parent;
                    M && M.parent && (I = {
                        x: M.parent.x,
                        y: M.parent.y
                    })
                ...
                var L = g[c.id];
                if (L) {
                    for (E = A.parent; null != E && -1 == c.ids.indexOf(A.id) && -1 == c.ids.indexOf(E.id);) E = E.parent;
                    E && (I = {
                        x: L.x + L.w / 2 - A.w / 2,
                        y: L.y + L.h / 2 - A.h / 2
                    })
                }
            } else if (d == OrgChart.action.centerNode && f && f[A.id]) {
                var B;
                if (null != (T = f[A.id]).x && null != T.y && (I = {
                    x: T.x,
                    y: T.y
                }), B = g[c.id]) (E = A.parent) && E.id == c.id && (I = {
                    x: B.x + B.w / 2 - A.w / 2,
                    y: B.y + B.h / 2 - A.h / 2
                })
            } else if (d == OrgChart.action.groupMaxMin && f && f[A.id]) {
                I = {
                    x: (T = f[A.id]).x,
                    y: T.y
                }
            } else if (d == OrgChart.action.insert && c && c.insertedNodeId == A.id) I = {
                x: A.parent.x,
                y: A.parent.y
            };
            else if ((d == OrgChart.action.update || d == OrgChart.action.insert) && f && f[A.id]) {
                var T;
                I = {
                    x: (T = f[A.id]).x,
                    y: T.y
                }
            } else d !== OrgChart.action.exporting && r && !r[A.id] && (m[0].push(A.id), m[1].push({
                opacity: 0
            }), m[2].push({
                opacity: 1
            }));
            null != I && (I.x == A.x && I.y == A.y || (m[0].push(A.id), m[1].push({
    ...
    minus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line>',
    nodeMenuButton: '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
    exportMenuButton: '<div style="position:absolute;right:{p}px;top:{p}px; width:30px;height:50px;cursor:pointer;" id="control-export-menu" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
...
}, OrgChart.templates.split = Object.assign({}, OrgChart.templates.ana), OrgChart.templates.split.size = [10, 10], OrgChart.templates.split.node = '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>',
    ...
    OrgChart.templates.olivia.field_0 = '<text width="220" class="field_0" style="font-size: 14px;" fill="#2b2a2a" x="10" y="30">{val}</text>',//empty because in search we have to remove the middle name otherwise replace field 4 with this
    OrgChart.templates.olivia.field_1 = '<text width="220" class="field_1" style="font-size: 14px;" fill="#2b2a2a" x="10" y="60">{val}</text>',
    OrgChart.templates.olivia.field_2 = '<text width="220" class="field_1" style="font-size: 14px;" fill="#2b2a2a" x="10" y="110">{val}</text>',
    //OrgChart.templates.olivia.field_3 = '<text width="220" class="field_1" style="font-size: 16px;" fill="#2b2a2a" x="190" y="115">{val}</text>',
    // OrgChart.templates.olivia.field_4 = '<text width="220" class="field_0" style="font-size: 18px;" fill="#2b2a2a" x="10" y="30">{val}</text>',
    ...
    OrgChart.templates.olivia.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,240,10)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="1.5" fill="#2b2a2a"></circle><circle cx="0" cy="5" r="1.5" fill="#2b2a2a"></circle><circle cx="0" cy="10" r="1.5" fill="#2b2a2a"></circle></g>',
    OrgChart.templates.belinda = Object.assign({}, OrgChart.templates.ana), OrgChart.templates.belinda.size = [180, 180], OrgChart.templates.belinda.ripple = {
        radius: 90,
        color: "#e6e6e6",
        rect: null
        ...
        defs: function () {
            var t = "";
            for (var e in OrgChart.templates) {
                var r = OrgChart.templates[e];
                r.defs ? (OrgChart.ui._defsIds[e] = OrgChart._randomId(), t += r.defs.replace("{randId}", OrgChart.ui._defsIds[e])) : t += r.defs
            }
            return "<defs>" + t + "</defs>"
        },
        css: function () {
        ...
        node: function (t, e, r, i, a, o, n, l, s, h) {
            ...
            var x = OrgChart.nodeOpenTag.replace("{id}", t.id).replace("{class}", O).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y),
                y = OrgChart._getOpacity(r, t);
            x = x.replace("{opacity}", y), t.isGroup || null == i.nodeMenu || "split" == t.templateName || l === OrgChart.action.exporting || (c += d.nodeMenuButton.replace("{id}", t.id));
            var v = OrgChart.ui._renderGroupedNodes(t, d, i, r, n, a, o, l, s);
            return t.isGroup && l != OrgChart.action.exporting && (t.groupState == OrgChart.EXPAND ? c += OrgChart.MINIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id) : c += OrgChart.MAXIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id)), c = x + c + v + OrgChart.grCloseTag
        },
        ...
        secondLinks: function (t, e, r, i, a) {
            ...
            for (var o = "", n = 0; n < e.spids.length; n++) {
                var l = [],
                    s = e.spids[n],
                    h = null,
                    d = "left";
                if (t[s]) {
                    ...
                    var c = OrgChart.t(e.templateName, a),
                        g = r.levelSeparation;
                    e.layout != OrgChart.mixed && e.layout != OrgChart.tree || (g = r.mixedHierarchyNodesSeparation);
                    var p = {
                    ...
                    for (var f = e; null == h;) {
                        ...
                        if (!u) {
                            ...
                            if (C.parent) switch (g = r.levelSeparation, C.parent.layout != OrgChart.mixed && C.parent.layout != OrgChart.tree || (g = r.mixedHierarchyNodesSeparation), r.orientation) {
                                ...
                                case OrgChart.orientation.left:
                                case OrgChart.orientation.left_top:
                                    x = C.parent.x + C.parent.w + g * (2 / 3), y = l[l.length - 1][1];
                                    break;
                                case OrgChart.orientation.right:
                                case OrgChart.orientation.right_top:
                                    x = C.parent.x - g * (2 / 3), y = l[l.length - 1][1]
                            }
                            l.push([x, y])
                        }
                        f = C
                    ...
                    l[0] = "M" + l[0].join(",");
                    for (var v = 1; v < l.length; v++) l[v] = "L" + l[v].join(",");
                    l = l.join(" "), o += OrgChart.secondLinkOpenTag.replace("{id}", e.id).replace("{child-id}", s) + c.secondLink.replace("{d}", l), o += OrgChart.grCloseTag
                }
            }
            return o
        },
        ...
        if (t || i !== OrgChart.match.boundary) return t || i !== OrgChart.match.width ? t || i !== OrgChart.match.height ? t ? (n = e / t[2], (l = r / t[3]) < n ? l : n) : i : r / o : e / a;
        var n = e / a,
            l = r / o;
        return l < n ? l : n
        ...
        if (l = parseFloat(l), a || (a = 0), o || (o = 0), a || (n = "start"), s || (s = "ellipsis"), "ellipsis" == s) {
            ...
            for (var c = d.getComputedTextLength(), g = 2; l < c;) d.textContent = t.substring(0, t.length - g), d.textContent, c = d.getComputedTextLength(), g++;
            var pendingContent = t.replace(d.textContent, '');
            return 2 < g ? "<title>" + t + "</title><tspan>" + d.textContent + "-</tspan><tspan x='10' dy='18'>" + pendingContent + "</tspan>" : t;
        }
        if ("multiline" == s) {
            var p = t.split(" "),
                f = d.getBBox().height;
        ...
        this.config.mouseScrool == OrgChart.action.xScroll && this.bar && function (t, i, e) {
            ...
            function r(t) {
                ...
                l.pos < 0 && (l.pos = 0), l.pos > r && (l.pos = r), a || o()
            }

            function o() {
                a = !0;
                var t = (l.pos - l.bar.scrollLeft) / e;
                0 < t ? t++ : t-- , l.bar.scrollLeft += t, l.bar.scrollLeft == l.pos ? a = !1 : n(o)
            }
            t.addEventListener("mousewheel", r, !1), t.addEventListener("DOMMouseScroll", r, !1);
            var n = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                setTimeout(t, 20)
            }
        }(t, 120, 12)
    }, OrgChart.xScrollUI.prototype.create = function (t) {
        var a = this;
        this.bar = document.createElement("div"), this.innerBar = document.createElement("div");
        this.requestParams();
        ...
        this.config.mouseScrool == OrgChart.action.yScroll && this.bar && function (t, i, e) {
            ...
            function o() {
                ...
                0 < t ? t++ : t-- , l.bar.scrollTop += t, l.bar.scrollTop == l.pos ? a = !1 : n(o)
            }
            t.addEventListener("mousewheel", r, !1), t.addEventListener("DOMMouseScroll", r, !1);
            var n = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                setTimeout(t, 20)
    ...
    }, OrgChart.yScrollUI.prototype.create = function (t, e) {
        var a = this;
        this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
            position: "absolute",
            right: 0,
            bottom: 0,
            height: t + "px",
