...
OrgChart.prototype.load = function (t) {
    ...
    return OrgChart._events.on(t, e), this
    ...
    return e
}, OrgChart.prototype._draw = function (t, m, O, y) {
    var x = this;
    ...
    this.server.read(t, this.width(), this.height(), e, m, O, function (t) {
        x.nodes = t.nodes, x.editUI.fields = t.allFields;
        var e = x.ui.defs(),
            r = x.getScale(t.viewBox);
        e += x.ui.pointer(x.config, m, r);
        var i = x.getViewBox(),
            a = t.viewBox;
        for (var n in x._initialized || (x.element.innerHTML = '<div id="bg-tests"></div>'), t.visibleNodes) {
            var o = t.visibleNodes[n];
            e += x.ui.node(o, x._get(n), t.animations, x.config, void 0, void 0, void 0, m, r, x), e += x.ui.secondLinks(t.visibleNodes, o, x.config, t.boundary, r), e += x.ui.link(o, x, x.config, r), e += x.ui.expandCollapse(o, x.config, m, r)
        }
        if (e += x.ui.lonely(x.config), m !== OrgChart.action.centerNode && m !== OrgChart.action.insert && m !== OrgChart.action.expandCollapse && m !== OrgChart.action.update || (a = i), m === OrgChart.action.init && null != i && (a = i), m !== OrgChart.action.exporting) {
            x.response = t;
            C = x.ui.svg(x.width(), x.height(), a, x.config, e);
            if (x._initialized) {
                var l = x.getSvg(),
                    s = l.parentNode;
                s.removeChild(l), s.insertAdjacentHTML("afterbegin", C), x._attachEventHandlers(), x.xScrollUI.addListener(x.getSvg()), x.yScrollUI.addListener(x.getSvg()), x.xScrollUI.setPosition(), x.yScrollUI.setPosition()
            } else {
                x.element.innerHTML = x.ui.css() + x.ui.exportMenuButton(x.config) + C, x._attachInitEventHandlers(), x._attachEventHandlers(), x.config.showXScroll === OrgChart.scroll.visible && (x.xScrollUI.create(x.width(), x.config.padding), x.xScrollUI.setPosition(), x.xScrollUI.addListener(x.getSvg())), x.config.showYScroll === OrgChart.scroll.visible && (x.yScrollUI.create(x.height(), x.config.padding), x.yScrollUI.setPosition(), x.yScrollUI.addListener(x.getSvg())), x.config.enableSearch && x.searchUI.addSearchControl(), x.toolbarUI.init(x, x.config.toolbar);
                var h = document.createElement("div");
                h.setAttribute("id", "bg-tests"), x.element.appendChild(h)
            }
            var d = !1;
            x.notifierUI.show(t.notif);
            var c = x.response.animations;
            if (0 < c[0].length) {
                x._hideBeforeAnimation(c[0].length);
                for (var g = 0; g < c[0].length; g++) c[0][g] = x.getNodeElement(c[0][g]);
                OrgChart.anim(c[0], c[1], c[2], x.config.anim.duration, x.config.anim.func, function () {
                    d || (y && y(), OrgChart._events.publish("redraw", [x]), x._showAfterAnimation(), d = !0)
                })
            }
            m === OrgChart.action.centerNode ? OrgChart.anim(x.getSvg(), {
                viewbox: i
            }, {
                    viewbox: x.response.viewBox
                }, x.config.anim.duration, x.config.anim.func, function () {
                    x.ripple(O.options.rippleId)
                }, function () {
                    x.xScrollUI.setPosition(), x.yScrollUI.setPosition(), d || (y && y(), OrgChart._events.publish("redraw", [x]), x._showAfterAnimation(), d = !0)
                }) : !i || !x.response || i[0] == x.response.viewBox[0] && i[1] == x.response.viewBox[1] && i[2] == x.response.viewBox[2] && i[3] == x.response.viewBox[3] || m !== OrgChart.action.insert && m !== OrgChart.action.expandCollapse && m !== OrgChart.action.update && m !== OrgChart.action.init ? 0 == c[0].length && (d || (y && y(), OrgChart._events.publish("redraw", [x]), d = !0)) : OrgChart.anim(x.getSvg(), {
                    viewbox: i
                }, {
                        viewbox: x.response.viewBox
                    }, 500, OrgChart.anim.inOutPow, function () {
                        x.xScrollUI.setPosition(), x.yScrollUI.setPosition(), d || (y && y(), OrgChart._events.publish("redraw", [x]), d = !0)
                    }), x._initialized = !0
        } else {
            var p = t.boundary,
                f = p.maxX - p.minX + 2 * x.config.padding,
                u = p.maxY - p.minY + 2 * x.config.padding,
                C = x.ui.svg(f, u, [p.minX - x.config.padding, p.minY - x.config.padding, f, u], x.config, e, r);
            y(C)
        }
    }, function (t) {
        OrgChart._events.publish("ready", [x, t])
    })
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            u.setAttribute("id", O);
            var y = OrgChart.t(i.templateName, this.getScale());
            C.setAttribute("x", y.ripple.rect ? y.ripple.rect.x : 0), C.setAttribute("y", y.ripple.rect ? y.ripple.rect.y : 0), C.setAttribute("width", y.ripple.rect ? y.ripple.rect.width : i.w), C.setAttribute("height", y.ripple.rect ? y.ripple.rect.height : i.h), C.setAttribute("rx", y.ripple.radius), C.setAttribute("ry", y.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", o), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", y.ripple.color), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, {
                r: 0,
                opacity: 1
            }, {
                    r: p,
    ...
    var r = this.get(t.id);
    if (!0 === e && this.config.onUpdate && !1 === OrgChart._events.publish("update", [that, r, t])) return !1;
    ...
    var r = this.getBGNode(t);
    if ((r.isChildOfGroup && this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), !0 === e) && !1 === OrgChart._events.publish("remove", [this, t])) return !1;
    ...
    if ((null == t.id && console.error("Call addNode without id"), !0 === e) && !1 === OrgChart._events.publish("add", [this, t])) return !1;
    this.config.nodes.push(t)
}, OrgChart.prototype.addTag = function (t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if ((i[t] = e, !0 === r) && !1 === OrgChart._events.publish("updatetags", [this, i])) return !1;
    this.config.tags = i
}, OrgChart.prototype.removeTag = function (t, e) {
    var r = JSON.parse(JSON.stringify(this.config.tags));
    if ((delete r[t], !0 === e) && !1 === OrgChart._events.publish("updatetags", [this, r])) return !1;
    this.config.tags = r
}, OrgChart.prototype._updateTag = function (t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if (i[t][e] = r, !1 === OrgChart._events.publish("updatetags", [this, i])) return !1;
    this.config.tags = i;
    var a = this;
    this._draw(!1, OrgChart.action.update, {
        id: t
                ...
                switch (e.toLowerCase()) {
                    case "d":
                        var a = f((10 * O - 10) / p) * (g[t][e][0] - c[t][e][0]) + c[t][e][0],
                            n = f((10 * O - 10) / p) * (g[t][e][1] - c[t][e][1]) + c[t][e][1];
                        d[t].setAttribute("d", d[t].getAttribute("d") + " L" + a + " " + n);
                        break;
                    case "r":
                        var o = f((10 * O - 10) / p) * (g[t][e] - c[t][e]) + c[t][e];
                    ...
                    case "margin":
                        if (g[t][e]) {
                            ...
                            d[t] && d[t].style && (d[t].style[e] = o)
                        }
                        break;
                    default:
                        o = f((10 * O - 10) / p) * (g[t][e] - c[t][e]) + c[t][e], d[t] && d[t].style && (d[t].style[e] = o + r)
                }
            }
        C && C(), 1 + y < (O += 1) && (clearInterval(m), u && u(d))
    }, 10)
    ...
    if (h.innerHTML = "Upload", h.style.position = "absolute", h.style.right = 0, n.style.margin = "14px 14px 7px 14px", n.style.textAlign = "left", n.style.position = "relative", s.style.border = "1px solid #d7d7d7", s.style.backgroundColor = "#d7d7d7", s.style.display = "block", s.style.width = "100%", o.style.floa = "left", o.style.color = "#bcbcbc", l.style.border = "none", l.style.outline = "none", l.style.width = "100%", a && (l.style.width = "80%"), l.style.fontSize = "16px", l.readOnly = i, null != e && null != e && (l.value = e), null != r && null != r && (l.placeholder = r), null != t && null != t && (o.innerHTML = t), o.setAttribute("label", t), l.style.color = "#7a7a7a", i || l.addEventListener("focus", function () {
        ...
        t.setAttribute("type", "file"), t.style.display = "none", t.onchange = function () {
            var t = this.files[0];
            OrgChart._events.publish("imageuploaded", [t, e.parentNode.querySelector("input")])
    ...
    if (e) {
        this.obj = t, this.toolbar = e, this._visible = !1, this.div = document.createElement("div"), Object.assign(this.div.style, {
            position: "absolute",
            padding: "3px",
...
}, OrgChart.prototype._export = function (o) {
    var l = this;
    if (o.filename || (o.filename = "OrgChart." + o.ext), null != o.nodeId) {
        var t = this.getBGNode(o.nodeId);
        t.isChildOfGroup && (o.nodeId = t._groupParentNodeId)
    }
    var e = {
        id: o.nodeId,
    ...
    this._draw(!1, OrgChart.action.exporting, e, function (t) {
        var n = document.createElement("div");
        if (n.innerHTML = t, "svg" == o.ext) {
            if (!1 === OrgChart._events.publish("exportend", [l, o, n.innerHTML])) return !1;
            OrgChart._downloadFile(o.mime, n.innerHTML, o.filename)
        } else {
            if (null == o.margin && (o.margin = {
                top: "20px",
                bottom: "20px",
                left: "20px",
                right: "20px"
            }), null == o.landscape && (o.landscape = !1), null == o.width) {
                var e = n.querySelector("svg").getAttribute("width");
                o.width = e
            }
            if (null == o.height) {
                var r = n.querySelector("svg").getAttribute("height");
                if (o.height = parseFloat(r), o.margin) {
                    var i = parseFloat(o.margin.bottom);
                    o.height += i;
                    var a = parseFloat(o.margin.top);
                    o.height += a
                }
            }
            null == o.extraHtml && (o.extraHtml = ""), OrgChart._imgs2base64(n, "image", "xlink:href", function () {
                if ("pdf" == o.ext && "A4" == o.format) {
                    var t = o.landscape ? OrgChart.A4h : OrgChart.A4w,
                        e = n.querySelector("svg"),
                    ...
                    //  i /= r / t, e.setAttribute("width", t), e.setAttribute("height", i), e.style.margin = "0 auto", e.setAttribute("preserveAspectRatio", "xMidYMin meet")
                }
                if (!1 === OrgChart._events.publish("exportstart", [l, o, n.querySelector("svg")])) return !1;
                var a = {
                    content: '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head><body style="margin:0;padding:0;">' + o.extraHtml + n.innerHTML + "</body></html>",
                    options: o
                };
                a = JSON.stringify(a), OrgChart._ajax(l.config.exportUrl + "/v1", "POST", a, "arraybuffer", function (t) {
                    if (!1 === OrgChart._events.publish("exportend", [l, o, t])) return !1;
                    OrgChart._downloadFile(o.mime, t, o.filename)
                })
            })
        }
    })
}, OrgChart.prototype.exportCSV = function (t) {
    if (t || (t = "OrgChart.csv"), !1 === OrgChart._events.publish("exportstart", [this, "csv", t])) return !1;
    var e = OrgChart._json2csv(this.config.nodes);
    if (!1 === OrgChart._events.publish("exportend", [this, "csv", t, e])) return !1;
    OrgChart._downloadFile("text/csv;charset=utf-8;", e, t)
}, OrgChart.prototype.exportXML = function (t) {
    if (t || (t = "OrgChart.xml"), !1 === OrgChart._events.publish("exportstart", [this, "xml", t])) return !1;
    var e = OrgChart._json2xml(this.config.nodes);
    if (!1 === OrgChart._events.publish("exportend", [this, "xml", t, e])) return !1;
    OrgChart._downloadFile("application/xml", e, t)
}, void 0 === OrgChart && (OrgChart = {}), OrgChart._events = function () {
    var i = {},
        a = i.hasOwnProperty;
    return {
        on: function (t, e) {
        ...
        publish: function (t, e) {
            a.call(i, t) && i[t].forEach(function (t) {
                return 1 == e.length ? t(e[0]) : 2 == e.length ? t(e[0], e[1]) : 3 == e.length ? t(e[0], e[1], e[2]) : 4 == e.length ? t(e[0], e[1], e[2], e[3]) : 5 == e.length ? t(e[0], e[1], e[2], e[3], e[4]) : void 0
            })
        }
    }
    ...
    if (e.collapsedChildrenIds.length) {
        if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.EXPAND, t, e.collapsedChildrenIds])) return !1;
        this.expand(t, e.collapsedChildrenIds, !1)
    } else {
        if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.COLLAPSE, t, e.childrenIds])) return !1;
    ...
    if (e.groupState == OrgChart.EXPAND) {
        if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.COLLAPSE, t])) return !1;
        this.minimize(t)
    } else if (e.groupState == OrgChart.COLLAPSE) {
        if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.EXPAND, t])) return !1;
        this.maximize(t)
    }
    ...
    if (this.config.enableDragDrop) {
        ...
        var h = this,
            ...
            u = h.getScale(),
            C = t.cloneNode(!0);
        if (d.insertBefore(C, d.firstChild), C.style.opacity = .7, n.isChildOfGroup) {
            var o = this.getNodeElement(n._groupParentNodeId),
                m = OrgChart._getTransform(o);
        ...
        var O = function (t) {
            ...
            var n = (r.x - c.x) / u,
                o = (r.y - c.y) / u;
            g[4] = p + n, g[5] = f + o, C.setAttribute("transform", "matrix(" + g.toString() + ")")
        },
            y = function (t) {
                if (d.removeEventListener(i.move, O), d.removeEventListener(i.up, y), i.leave && d.removeEventListener(i.leave, y), n.id == l || n.isChildOfGroup && n._groupParentNodeId == l || null == l) return d.removeChild(C), void (h._gragStartedId = null);
                var e = h.getBGNode(l);
                if (null == h.config.dragDropMenu || n.isGroup && !e.isGroup) h._canUpdateLink(n.id, l) ? h.linkNode(n.id, l) : d.removeChild(C);
                else if (h._canUpdateLink(n.id, l)) {
                    var r = OrgChart._getOffsetXY(h.element, t);
                    h.dragDropMenuUI.show(r.x, r.y, n.id, l)
                } else d.removeChild(C);
                h._gragStartedId = null
            };
        d.addEventListener(i.move, O), d.addEventListener(i.up, y), i.leave && d.addEventListener(i.leave, y)
    }
    ...
    if (!1 === OrgChart._events.publish("dbclick", [this, this.get(t)])) return !1;
    this._commonClickHandler(t, e, this.config.nodeMouseDbClick)
}, OrgChart.prototype._nodeClickHandler = function (t, e) {
    if (!1 === OrgChart._events.publish("click", [this, this.get(t)])) return !1;
    ...
    if (r == OrgChart.action.expandCollapse) {
        if (i.collapsedChildrenIds.length) {
            if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.EXPAND, t, i.collapsedChildrenIds])) return !1;
            this.expand(t, i.collapsedChildrenIds, !1)
        } else {
            if (!1 === OrgChart._events.publish("expcollclick", [this, OrgChart.COLLAPSE, t, i.childrenIds])) return !1;
    ...
    for (var i = [], a = [], n = [], o = 0; o < t.length; o++) OrgChart.local._firstWalk(t[o], 0, i, a, n, e), OrgChart.local._secondWalk(t[o], 0, 0, 0, i, a, e);
    r()
}, OrgChart.local._firstWalk = function (t, e, r, i, a, n) {
    var o = null;
    if (t.x = 0, t.y = 0, t._prelim = 0, t._modifier = 0, t.level = e, t.leftNeighbor = null, t.rightNeighbor = null, OrgChart.local._setLevelHeight(t, e, r), OrgChart.local._setLevelWidth(t, e, i), OrgChart.local._setNeighbors(t, e, a), 0 == OrgChart.local._getChildrenCount(t) || e == OrgChart.MAX_DEPTH)
        if (null != (o = OrgChart.local._getLeftSibling(t))) {
            var l = n.siblingSeparation;
            2 == o.layout && (l = n.mixedHierarchyNodesSeparation), t._prelim = o._prelim + OrgChart.local._getNodeWidth(o, n) + l
        } else t._prelim = 0;
    else {
        for (var s = OrgChart.local._getChildrenCount(t), h = 0; h < s; h++) {
            var d = OrgChart.local._getChildAt(t, h);
            OrgChart.local._firstWalk(d, e + 1, r, i, a, n)
        }
        var c = OrgChart.local._getFirstChild(t),
            g = OrgChart.local._getLastChild(t),
            p = c._prelim + (g._prelim - c._prelim + OrgChart.local._getNodeWidth(g, n)) / 2;
        if (p -= OrgChart.local._getNodeWidth(t, n) / 2, null != (o = OrgChart.local._getLeftSibling(t))) {
            l = n.siblingSeparation;
            2 == o.layout && (l = n.mixedHierarchyNodesSeparation), t._prelim = o._prelim + OrgChart.local._getNodeWidth(o, n) + l, t._modifier = t._prelim - p, OrgChart.local._apportion(t, e, n)
        } else n.orientation <= 3 ? t._prelim = p : t._prelim = 0
    }
    ...
    if (e <= OrgChart.MAX_DEPTH) {
        ...
        if (0 != OrgChart.local._getChildrenCount(t)) {
            var p = o.levelSeparation;
            t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (p = o.mixedHierarchyNodesSeparation), OrgChart.local._secondWalk(OrgChart.local._getFirstChild(t), e + 1, r + t._modifier, i + h + p, a, n, o)
        }
    ...
    for (var i = OrgChart.local._getFirstChild(t), a = i.leftNeighbor, n = 1, o = OrgChart.MAX_DEPTH - e; null != i && null != a && n <= o;) {
        for (var l = 0, s = 0, h = i, d = a, c = 0; c < n; c++) h = h.parent, d = d.parent, l += h._modifier, s += d._modifier;
        ...
        n++ , null != (i = 0 == OrgChart.local._getChildrenCount(i) ? OrgChart.local._getLeftmost(t, 0, n) : OrgChart.local._getFirstChild(i)) && (a = i.leftNeighbor)
    }
    ...
    for (var i = OrgChart.local._getChildrenCount(t), a = 0; a < i; a++) {
        var n = OrgChart.local._getChildAt(t, a),
            o = OrgChart.local._getLeftmost(n, e + 1, r);
        if (null != o) return o
    }
    return null
    ...
    var n = function () {
        ...
        l = function () {
            var t = i.querySelector('[data-selected="yes"]').getAttribute("data-search-item-id"),
                e = OrgChart._events.publish("searchclick", [r.obj, t]);
    ...
    for (o = 0; o < h.length; o++) h[o].addEventListener("click", function () {
        var t = OrgChart._events.publish("searchclick", [e.obj, this.getAttribute("data-search-item-id")]);
    ...
    for (var e, i, a, n = function (t) {
        ...
        for (var d in h) {
            var c = h[d];
            0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d) || c && -1 != c.toString().toLowerCase().indexOf(t) && !OrgChart._fieldIsImg(this.config, d) && o.push({
                id: h.id,
                propertyName: d,
                isId: d == OrgChart.ID,
                isNodeParam: n(d),
        ...
        for (var g = !1, p = 0; p < l.length; p++)
            if (l[p].id == o[s].id) {
                ...
                for (p = 0; p < O.length; p++) {
                    d = O[p], c = o[s].data[d];
                    d === o[s].propertyName && (i = t, void 0, a = (e = c).toString().toLowerCase().indexOf(i), c = e.toString().splice(a + i.length, 0, "</mark>").splice(a, 0, "<mark>")), d != OrgChart.TAGS && (d == OrgChart.ID ? u = u + c + ", " : OrgChart._fieldIsImg(this.config, d) ? m = c : n(d) && !OrgChart._fieldIsImg(this.config, d) ? f = f + c + ", " : OrgChart._fieldIsImg(this.config, d) || (C = C + c + ", "))
                }
                u = u.slice(0, u.length - 2), f = f.slice(0, f.length - 2), C = C.slice(0, C.length - 2);
                var y = OrgChart._getTemplate(o[s].tags, this.config.tags, this.config.template);
                l.push({
                    id: o[s].id,
                    node: new OrgChart.node(o[s], null, null, [], y),
                    textId: u,
                    textInNode: f,
                    text: C,
                    img: m
    ...
    for (var a = t.nodes, n = {}, o = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        ...
        if ((x = new OrgChart.node(g.id, g.pid, C, p, u)).isAssistant = -1 != p.indexOf("assistant"), x.isAssistant && -1 == s.indexOf(x.pid) && s.push(x.pid), null != f) {
            if (!n[f.name]) {
                o.push(f.name);
                var m = new OrgChart.node(f.name, g.pid, null, [f.name], f.tag.template);
                m.isGroup = !0, null != t.orderBy && (m.order = g[t.orderBy]), n[f.name] = m
            }
            x.isChildOfGroup = !0, x._groupParentNodeId = f.name, n[f.name].bgnodes.push(x), h[x.id] = f.name, d = !0
        } else null != t.orderBy && (x.order = g[t.orderBy]), n[g.id] = x, o.push(g.id)
    }
    ...
    for (c = 0; c < o.length; c++) {
        var y = o[c],
            x = n[y],
            v = i ? i[y] : null;
        if (null != x.pid && null != x.pid && "" != x.pid) (_ = n[x.pid]) ? ((x.parent = _).children.push(x), _.childrenIds.push(x.id)) : (x.pid = null, x.parent = null, l.push(x));
        else l.push(x);
        e == OrgChart.action.exporting && null != r.id && (l = [n[r.id]]), v ? (x.state = v.state, x.state == OrgChart.COLLAPSE && O.push(x.id), OrgChart.server._setNodeGroupState(x, v.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(x, OrgChart.EXPAND, t.orientation), OrgChart.server._initStates(x, n, e, t, r, h, O), OrgChart.server._initGroupStates(x, n, e, t, r)
    }
    if (null != t.roots) {
        l = [];
            ...
            if (b) {
                if (b.parent)
                    for (var w = (_ = b.parent).children.length - 1; 0 <= w; w--) {
                        (F = _.children[w]) == b && (F.parent = null, _.children.splice(w, 1), _.childrenIds.splice(w, 1))
                    }
                l.push(b)
            }
        }
    ...
    for (c = 0; c < s.length; c++) {
        ...
        (v = i[(n[k.id] = k).id]) && (n[k.id].state = v.state, n[k.id].state == OrgChart.COLLAPSE && O.push(k.id)), OrgChart.server._initStates(k, n, e, t, r, h, O);
        var N = [];
        for (w = _.children.length - 1; 0 <= w; w--) {
            (F = _.children[w]).isAssistant ? (F.parent = null, _.children.splice(w, 1), _.childrenIds.splice(w, 1), N.splice(0, 0, F.id)) : (F.pid = k.id, (F.parent = k).children.push(F), k.childrenIds.push(F.id), _.children.splice(w, 1))
        }
        if (N.length % 2) {
            var S = n[N[N.length - 1]],
            ...
            OrgChart.templates[I] = {
                ...
                nodeMenuButton: "",
                size: A.size
            }, (J = new OrgChart.node(_.id + "_transperant", S.pid, null, [], I)).isAssistant = !0, (v = i[(n[J.id] = J).id]) && (n[J.id].state = v.state, n[J.id].state == OrgChart.COLLAPSE && O.push(J.id)), OrgChart.server._initStates(J, n, e, t, r, h, O), N.splice(N.length - 1, 0, J.id)
        }
        var E = 1;
        for (w = N.length - 1; 0 <= w; w--)
            if (w % 2 && w != N.length - 1) {
                var M = new OrgChart.node(_.id + "_split_" + E, null, null, [], "split");
                (v = i[(n[M.id] = M).id]) && (n[M.id].state = v.state, n[M.id].state == OrgChart.COLLAPSE && O.push(M.id)), OrgChart.server._initStates(M, n, e, t, r, h, O), N.splice(w, 0, M.id), E++
            } else w % 2 && N.splice(w, 0, k.id);
        for (w = 0; w < N.length; w += 3) {
            var L = null;
            L = 0 == w ? _ : n[N[w - 2]];
            var B = n[N[w]],
                T = n[N[w + 1]],
                H = n[N[w + 2]];
            B.parent = L, B.pid = L.id, T.parent = L, T.pid = L.id, H.parent = L, H.pid = L.id, L.children.push(B), L.children.push(T), L.children.push(H), L.childrenIds.push(B.id), L.childrenIds.push(T.id), L.childrenIds.push(H.id);
            for (var P = L;
                "split" == P.templateName && (P = P.parent);) P.childrenIds.push(B.id), P.childrenIds.push(T.id), P.childrenIds.push(H.id)
        }
    }
    if (e == OrgChart.action.centerNode) {
        var z = n[r.id];
        z || (z = n[h[r.id]], OrgChart.server._setNodeGroupState(z, OrgChart.EXPAND, t.orientation)), z.state = OrgChart.EXPAND, -1 != (G = O.indexOf(z.id)) && O.splice(G, 1);
        _ = OrgChart.server._getRealParent(z);
        for (var j = z.id; null != _;) {
            if (-1 != (G = O.indexOf(_.id)) && O.splice(G, 1), _.state = OrgChart.EXPAND, r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < _.childrenIds.length; c++) {
                    var F = n[_.childrenIds[c]];
                    if (!OrgChart.server._isSplit(F) && !F.isAssistant && F.id != j) - 1 == (G = O.indexOf(_.childrenIds[c])) && O.push(_.childrenIds[c]), F.state = OrgChart.COLLAPSE
                }
            if (_.state == OrgChart.EXPAND)
                for (var U = 0; U < _.childrenIds.length; U++) {
                    var D = n[_.childrenIds[U]];
                    if (OrgChart.server._isSplit(D) || D.isAssistant) - 1 != (G = O.indexOf(D.id)) && O.splice(G, 1), D.state = OrgChart.EXPAND
                }
            j = _.id, _ = OrgChart.server._getRealParent(_)
        }
        if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < z.childrenIds.length; c++) {
                if (-1 != (G = O.indexOf(z.childrenIds[c])) && O.splice(G, 1), (F = n[z.childrenIds[c]]).state = OrgChart.EXPAND, !F.isAssistant && !OrgChart.server._isSplit(F))
                    for (w = 0; w < F.childrenIds.length; w++) {
                        var G, X = n[F.childrenIds[w]]; - 1 == (G = O.indexOf(F.childrenIds[w])) && O.push(F.childrenIds[w]), X.state = OrgChart.COLLAPSE
                    }
            }
    }
    e == OrgChart.action.exporting && 1 == r.expandChildren && x && (O = []);
    for (c = 0; c < O.length; c++) {
        if (_ = (x = n[O[c]]).parent)
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (_.children[w] == x)
                    if (-1 == _.collapsedChildrenIds.indexOf(x.id) && _.collapsedChildrenIds.push(x.id), _.children.splice(w, 1), "split" == x.templateName || "split" == _.templateName) {
                        if (L = x.parent) {
                            for (;
    ...
    if (t.layout == OrgChart.mixed)
        for (c = 0; c < o.length; c++) {
            if (0 == (x = n[o[c]]).childrenIds.length && !x.isAssistant && "split" != x.templateName)
                if (_ = x.parent)
                    for (w = _.children.length - 1; 0 <= w; w--) {
                        if ((F = _.children[w]) != x && 0 == F.childrenIds.length && !F.isAssistant && "split" != F.templateName) {
                            F.parent = x, F.pid = x.id, F.layout = OrgChart.mixed, _.children.splice(w, 1);
                            var V = x.children.length;
                            x.children[V] = F, x.layout = OrgChart.mixed
                        }
                    }
        }
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        var q = [];
        for (c = 0; c < o.length; c++) {
            if (0 == (x = n[o[c]]).childrenIds.length && !x.isAssistant && "split" != x.templateName) (_ = x.parent) && -1 == q.indexOf(_.id) && q.push(_.id)
        }
        for (c = 0; c < q.length; c++) {
            ...
            var W = [];
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (0 == (F = _.children[w]).childrenIds.length && !F.isAssistant && "split" != F.templateName && F.parent && "split" != F.parent.templateName) {
                    if ((F = _.children[w]).parent = null, F.layout = OrgChart.tree, _.children.splice(w, 1), _.childrenIds.splice(w, 1), t.layout == OrgChart.treeRightOffset && W.splice(0, 0, F.id), t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                        var J;
                        I = "transperant_" + F.templateName;
                        OrgChart.templates[I] = {
                            linkAdjuster: {},
                            link: "",
                            node: "",
                            nodeMenuButton: "",
                            size: [0, 0]
                        }, (J = new OrgChart.node(F.id + "_transperant", null, null, [], I)).layout = OrgChart.tree, n[J.id] = J, W.splice(0, 0, J.id)
                    }
                    t.layout != OrgChart.treeRightOffset && W.splice(0, 0, F.id)
                }
            }
            for (E = 1, w = W.length - 1; 0 <= w; w--) {
                if (w % 2 && w != W.length - 1) (M = new OrgChart.node(_.id + "_split_" + E, null, null, [], "split")).layout = OrgChart.tree, n[M.id] = M, W.splice(w, 0, M.id), E++;
                else w % 2 && W.splice(w, 0, k.id)
            }
            for (w = 0; w < W.length; w += 3) {
                L = null;
                0 == w && (L = _);
                B = n[W[w]], T = n[W[w + 1]], H = n[W[w + 2]];
                0 != w && (L = n[W[w - 3]]), 0 == w || T || (L = n[W[w - 2]]), B.parent = L, B.pid = L.id, L.children.push(B), _.childrenIds.push(B.id), T && (0 != w && (L = n[W[w - 2]]), T.parent = L, T.pid = L.id, L.children.push(T), _.childrenIds.push(T.id)), H && (0 != w && (L = n[W[w - 1]]), H.parent = L, H.pid = L.id, L.children.push(H), _.childrenIds.push(H.id))
            }
        }
    }
    return {
    ...
    return e
}, OrgChart.server._initStates = function (t, e, r, i, a, n, o) {
    if (r == OrgChart.action.init && t) {
        if (t.tags)
            for (var l = 0; l < t.tags.length; l++) {
                var s = t.tags[l];
                i.tags && i.tags[s] && null != i.tags[s].state && (i.tags[s].state == OrgChart.COLLAPSE && o.push(t.id), t.state = i.tags[s].state)
            }
        if (i.collapse.level) {
            ...
            if (h >= i.collapse.level) {
                ...
                !c && i.collapse.allChildren ? (o.push(t.id), t.state = OrgChart.COLLAPSE) : c || i.collapse.allChildren || h != i.collapse.level || (o.push(t.id), t.state = OrgChart.COLLAPSE)
            }
        }
        ...
        if (a.state == OrgChart.COLLAPSE) o.push(t.id);
            ...
            var g = o.indexOf(t.id); - 1 != g && o.splice(g, 1)
        }
        t.state = a.state
    }
    ...
    var u = {},
        ...
        O = a - o + 2 * i.padding,
        y = n - l + 2 * i.padding,
        x = OrgChart.getScale(s, t, e, i.scaleInitial, O, y);
    if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / x, C.right = a + i.padding - t / x, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, null == s && i.align == OrgChart.CENTER) {
        var v = Math.ceil(t / x),
            b = Math.ceil(e / x),
            w = 0,
            _ = 0;
        if (v - 2 * i.padding >= a - o) switch (w = (a + o) / 2 - v / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                w = (o - a) / 2 - v / 2
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                (w = -(v / 2 - (o - a) / 2)) < i.padding - v && (w = i.padding - v);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.bottom_left:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.left_top:
                (w = -(v / 2 - (a - o) / 2)) > -i.padding && (w = -i.padding)
        }
        ...
        v = Math.ceil(t / x), b = Math.ceil(e / x), w = 0, _ = 0;
    ...
    d == OrgChart.action.centerNode && ((B = g[c.id]) || (B = g[p[c.id]]), 1 == c.options.horizontal && (s[0] = B.x + B.w / 2 - s[2] / 2), 1 == c.options.vertical && (s[1] = B.y + B.h / 2 - s[3] / 2), s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left), s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right), s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top), s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom));
    ...
    OrgChart.templates.group_orange.size = [250, 120], OrgChart.templates.group_orange.node = '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#ffe6cc" stroke-width="1" stroke="#F57C00"></rect>',
    OrgChart.templates.group_orange.groupPadding = [50, 10, 10, 10], OrgChart.templates.group_orange.groupNodesSeparation = 10, OrgChart.templates.group_orange.groupName = '<text width="190" text-overflow="multiline"  class="groupName"  style="font-size: 24px;" fill="#F57C00" x="20" y="40">{val}</text>',
    ...
    OrgChart.templates.ula.menu = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,12)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#ffffff" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#039BE5"></circle><circle cx="7" cy="0" r="2" fill="#039BE5"></circle><circle cx="14" cy="0" r="2" fill="#039BE5"></circle></g>', OrgChart.templates.ula.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="7" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="14" cy="0" r="2" fill="#AEAEAE"></circle></g>',
    OrgChart.templates.olivia = Object.assign({}, OrgChart.templates.ana),

    OrgChart.templates.olivia.field_3 = '<text width="220" class="field_0" style="font-size: 14px;" fill="#2b2a2a" x="5" y="18">{val}</text>',
    OrgChart.templates.olivia.field_4 = '<text width="220" class="field_0" style="font-size: 14px;" fill="#2b2a2a" x="215" y="18">{val}</text>',

    OrgChart.templates.olivia.field_0 = '<text class="field_0 hideName" style="font-size: 14px;" fill="#2b2a2a" x="120" y="45" text-anchor="middle">{val}</text>',
    OrgChart.templates.olivia.field_1 = '<text width="230" class="field_1" text-overflow="multiline" style="font-size: 14px;" fill="#2b2a2a" x="125" y="65" text-anchor="middle">{val}</text>',
    OrgChart.templates.olivia.field_2 = '<text class="field_2" style="font-size: 14px;" fill="#2b2a2a" x="125" y="95" text-anchor="middle">{val}</text>',

    OrgChart.templates.olivia.field_5 = '<text width="220" class="field_0" style="font-size: 14px;" fill="#2b2a2a" x="5" y="110">{val}</text>',
    OrgChart.templates.olivia.field_6 = '<text width="220" class="field_0" style="font-size: 14px;" fill="#2b2a2a" x="220" y="110">{val}</text>',
    ...
    OrgChart.templates.olivia.node = '<rect fill="#FFFFFF" x="0" y="0" height="120" width="250" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>',
    ...
    OrgChart.templates.belinda = Object.assign({}, OrgChart.templates.ana), OrgChart.templates.belinda.size = [180, 180], OrgChart.templates.belinda.ripple = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            var y = OrgChart.nodeOpenTag.replace("{id}", t.id).replace("{class}", O).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y),
                x = OrgChart._getOpacity(r, t);
            y = y.replace("{opacity}", x), t.isGroup || null == i.nodeMenu || "split" == t.templateName || l === OrgChart.action.exporting || (c += d.nodeMenuButton.replace("{id}", t.id));
            var v = OrgChart.ui._renderGroupedNodes(t, d, i, r, o, a, n, l, s);
            return t.isGroup && l != OrgChart.action.exporting && (t.groupState == OrgChart.EXPAND ? c += OrgChart.MINIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id) : c += OrgChart.MAXIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id)), c = y + c + v + OrgChart.grCloseTag
        },
                    ...
                    for (var f = e; null == h;) {
                        ...
                        if (!u) {
                            ...
                            if (C.parent) switch (g = r.levelSeparation, C.parent.layout != OrgChart.mixed && C.parent.layout != OrgChart.tree || (g = r.mixedHierarchyNodesSeparation), r.orientation) {
                                ...
                                case OrgChart.orientation.left:
                                case OrgChart.orientation.left_top:
                                    y = C.parent.x + C.parent.w + g * (2 / 3), x = l[l.length - 1][1];
                                    break;
                                case OrgChart.orientation.right:
                                case OrgChart.orientation.right_top:
                                    y = C.parent.x - g * (2 / 3), x = l[l.length - 1][1]
                            }
                            l.push([y, x])
                        }
                        f = C
        ...
        if (t || i !== OrgChart.match.boundary) return t || i !== OrgChart.match.width ? t || i !== OrgChart.match.height ? t ? (o = e / t[2], (l = r / t[3]) < o ? l : o) : i : r / n : e / a;
        var o = e / a,
            l = r / n;
        return l < o ? l : o
        ...
        if ("multiline" == s) {
            ...
            for (var m = 1; m < p.length; m++) {
                var O = u.firstChild.data.length;//for decreasing the space between multi text content minus 6 added manually
                if (u.firstChild.data += " " + p[m], u.getComputedTextLength() > l) u.firstChild.data = u.firstChild.data.slice(0, O), (u = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", (n + f * g) - 6), u.setAttributeNS(null, "text-anchor", o), C = document.createTextNode(p[m]), u.appendChild(C), d.appendChild(u), g++
            }
            var y = "";
            if (null != d.innerHTML) y = d.innerHTML, d.innerHTML = "";
            else {
                var x = "";
