...
{
    [RoutePrefix("EEOGenderCompensationReport")]
    [Authorize()]
    public class EEOGenderCompensationReportController : Controller
    {
        // GET: Country
        IEEOGenderCompensationReportService _EEOGenderCompensationReportService;
        IEEOCompensationReportService _EEOCompensationReportService;
        IOrganizationsService _OrganizationsService;
        IEmployeeService _EmployeeService;
        public EEOGenderCompensationReportController()
        {
            _EEOGenderCompensationReportService = new EEOGenderCompensationReportService();
        ...
        public ActionResult GetEEOGenderCompensationReport(int? organization, int? filesubmission, int? eeojobcategory, int jobtitlesortorder, string eeoprogramoffice, string eeopositiontitle, string region)
        {
            try
            {
                ...
                var modelEEOGenderCompensationReport = _EEOGenderCompensationReportService.GetEEOGenderCompensationReportService(organization, filesubmission, eeojobcategory, jobtitlesortorder, eeoprogramoffice, eeopositiontitle, region);
                return PartialView("~/Views/EEOGenderCompensationReport/Partials/EEOGenderCompensationReport.cshtml", modelEEOGenderCompensationReport);
            }
            catch
            {
                return RedirectToAction("Errorwindow", "Home");
        ...
        //        //int organisastionId = AccountService.GetDashboardOrganisationID();
        //        //int FileSubmissionID = AccountService.GetFileSubmissionID(organisastionId, filename);
        //        var modelEEOGenderCompensationReport = _EEOGenderCompensationReportService.GetEEOGenderCompensationReportService(organization, filesubmission, eeojobcategory, jobtitlesortorder, eeoprogramoffice, eeopositiontitle);

        //        string htmlString = RenderViewAsString("~/Views/EEOGenderCompensationReport/Partials/EEOGenderCompensationReportPDF.cshtml", modelEEOGenderCompensationReport);
        ...
        public ActionResult ExportEEOReport(int? organization, int? filesubmission, int? eeojobcategory, int jobtitlesortorder, string eeoprogramoffice, string eeopositiontitle, string region)
        {
            try
            {
                var modelEEOGenderCompensationReport = _EEOGenderCompensationReportService.GetEEOGenderCompensationExportService(organization, filesubmission, eeojobcategory, jobtitlesortorder, eeoprogramoffice, eeopositiontitle, region);
                return View(modelEEOGenderCompensationReport);
            }
            catch
            {
                return RedirectToAction("Errorwindow", "Home");
        ...
        public ActionResult ExportToPDF(int? organization, int? filesubmission, int? eeojobcategory, int jobtitlesortorder, string eeoprogramoffice, string eeopositiontitle, string region)
        {
            ...
            string url = string.Format(ConfigurationManager.AppSettings["AppUrl"] + "/EEOGenderCompensationReport/ExportEEOReport?organization={0}&filesubmission={1}&eeojobcategory={2}&jobtitlesortorder={3}&eeoprogramoffice={4}&eeopositiontitle={5}&region={6}", organization, filesubmission, eeojobcategory, jobtitlesortorder, eeoprogramoffice, eeopositiontitle, region);
        ...
        private string RenderViewAsString(string viewName, EEOGenderCompensationReportModel model)
        {
