...
{
    public class ALMByEEOCategoryReportModel
    {
        public String DiplatTitleName { get; set; }
        public String DiplatContent { get; set; }
        public List<RacesForALMByEEOCategory> ListOfRaces { get; set; }
        public List<ALMByEEOCategory> ListALMByEEOCategory { get; set; }
    ...
    public class RacesForALMByEEOCategory
    {
        public int RacesId { get; set; }
        public string RacesName { get; set; }
    }
    public class ALMByEEOCategory
    {
    ...
    public class DefaultALMValue
    {
        public int DefaultALMState { get; set; }
        public int DefaultALMOccupationalCode { get; set; }
    }
}
