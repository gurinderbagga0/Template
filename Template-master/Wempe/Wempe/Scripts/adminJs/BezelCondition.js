...
function getList(pageNo) {
    ...
    $.ajax({
        url: siteUrl + 'BezelCondition/getList',
...
function Add() {
    ...
    var model =
    {
        BezelConditionID: parseInt($('#hdnid').val()),
        BezelCondition: $('#txtName').val(),
    ...
    $.ajax({
        url: siteUrl + 'BezelCondition/Add',
        type: 'POST',
        headers: { "requestType": "client" },
        data: JSON.stringify(model),
        contentType: 'application/json;charset=utf-8',
...
function Edit(id) {
    ...
    jQuery.ajax({
        url: siteUrl + 'BezelCondition/Edit',
        dataType: 'json',
        headers: { "requestType": "client" },
        data: { "id": id },
        contentType: 'application/json;charset=utf-8',
        success: function (data) {
            ...
            $('#hdnid').val(data.BezelConditionID);
            $('#txtName').val(data.BezelCondition);
