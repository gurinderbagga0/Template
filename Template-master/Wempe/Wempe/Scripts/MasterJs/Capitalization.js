...
function getList(pageNo) {
    ...
    $.ajax({
        url: siteUrl + 'Master/getCapitalizationList',
...
function Add() {
    ...
    var model =
    {
        ...
        capitalization: $('#txtName').val(),
        brandId: parseInt($('#drpBrands').val()),
        IsActive: $('#chkIsActive').is(':checked')
    };
    $.ajax({
        url: siteUrl + 'Master/AddCapitalization',
        type: 'POST',
        headers: { "requestType": "client" },
        data: JSON.stringify(model),
        contentType: 'application/json;charset=utf-8',
...
function Edit(id) {
    ...
    jQuery.ajax({
        url: siteUrl + 'Master/EditCapitalization',
        dataType: 'json',
        headers: { "requestType": "client" },
        data: { "id": id },
        contentType: 'application/json;charset=utf-8',
        success: function (data) {
            ...
            $('#hdnid').val(data.Id);
            $('#txtName').val(data.capitalization);
