...
function Add() {
    ...
    $.ajax({
        url: siteUrl + 'Master/AddWarrantyDoc',
        type: 'POST',
        headers: { "requestType": "client" },
        data: JSON.stringify(model),
        contentType: 'application/json;charset=utf-8',
...
function Edit(id) {
    ...
    jQuery.ajax({
        url: siteUrl + 'Master/EditWarrantyDoc',
        dataType: 'json',
        headers: { "requestType": "client" },
        data: { "id": id },
        contentType: 'application/json;charset=utf-8',
        success: function (data) {
            ...
            $('#hdnid').val(data.Id);
            $('#txtName').val(data.WarrantyDocument);
