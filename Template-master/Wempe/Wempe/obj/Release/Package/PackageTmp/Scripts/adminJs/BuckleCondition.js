...
function getList(pageNo) {
    ...
    $.ajax({
        url: siteUrl + 'BuckleCondition/getList',
...
function Add() {
    ...
    var model =
    {
        BuckleConditionID: parseInt($('#hdnid').val()),
        BuckleCondition: $('#txtName').val(),
    ...
    $.ajax({
        url: siteUrl + 'BuckleCondition/Add',
        type: 'POST',
        headers: { "requestType": "client" },
        data: JSON.stringify(model),
        contentType: 'application/json;charset=utf-8',
...
function Edit(id) {
    ...
    jQuery.ajax({
        url: siteUrl + 'BuckleCondition/Edit',
        dataType: 'json',
        headers: { "requestType": "client" },
        data: { "id": id },
        contentType: 'application/json;charset=utf-8',
        success: function (data) {
            ...
            $('#hdnid').val(data.BuckleConditionID);
            $('#txtName').val(data.BuckleCondition);
