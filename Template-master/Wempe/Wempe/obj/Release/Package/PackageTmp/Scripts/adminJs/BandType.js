...
function getList(pageNo) {
    ...
    $.ajax({
        ...
        error: function (_data) {
            ...
            $('#tbodyDetails').html('<tr><td colspan="5">'+_data.statusText+'</td></tr>');
        }
    });
}
...
function Add() {
    ...
    var model =
    {
        BandTypeID: parseInt($('#hdnid').val()),
        BandType: $('#txtName').val(),
...
function Edit(id) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            $('#hdnid').val(data.BandTypeID);
            $('#txtName').val(data.BandType);
