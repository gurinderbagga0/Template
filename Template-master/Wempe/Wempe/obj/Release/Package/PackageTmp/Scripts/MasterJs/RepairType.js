...
function getList(pageNo) {
    ...
    $.ajax({
        url: siteUrl + 'Master/getRepairTypeList',
...
function Add() {
    ...
    $.ajax({
        url: siteUrl + 'Master/AddRepairType',
        type: 'POST',
        headers: { "requestType": "client" },
        data: JSON.stringify(model),
        contentType: 'application/json;charset=utf-8',
...
function Edit(id) {
    ...
    jQuery.ajax({
        url: siteUrl + 'Master/EditRepairType',
        dataType: 'json',
        headers: { "requestType": "client" },
        data: { "id": id },
        contentType: 'application/json;charset=utf-8',
