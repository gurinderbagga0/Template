...
{
    public class UPasswordRijndaelAlgorithm
    {
        //string passPhrase = "TestPassphrase";        // can be any string
        //string saltValue = "TestSaltValue";        // can be any string
        //string hashAlgorithm = "SHA256";             // can be "SHA256" or "MD5"
        //int passwordIterations = 2;                // can be any number
        //string initVector = "!XXXASds"; // must be 16 bytes
        //int keySize = 256;                // can be 192 or 128
        static int keySize = 256;
        static int passwordIterations = 100;
        ...
        public static string Encrypt(string plainText, string saltValue
            , string passPhrase, string hashAlgorithm, string initVector
            )
        {
        ...
        (string cipherText, string saltValue
            , string passPhrase, string hashAlgorithm, string initVector)
        {
